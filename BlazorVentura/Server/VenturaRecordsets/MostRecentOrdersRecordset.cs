...
namespace BlazorVentura.Server.VenturaRecordsets
{
	/// <summary>
	...
	public partial class MostRecentOrdersRecordset : ResultsetObservable<MostRecentOrdersRecordset, MostRecentOrdersRecord>, IRecordsetBase
	{
		...
		public MostRecentOrdersRecordset()
		{
			...
			schema_array.Add(new VenturaSqlColumn("OrderStatusName", typeof(string), false)
			{
				ProviderType = 16,
				IsAliased = true,
				BaseCatalogName = "main",
			...
			schema_array.Add(new VenturaSqlColumn("ShipCountryName", typeof(string), false)
			{
				ProviderType = 16,
				IsAliased = true,
				BaseCatalogName = "main",
		...
		{
			get { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); return CurrentRecord.OrderStatusName; }
			set { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); CurrentRecord.OrderStatusName = value; }
		}
		...
		{
			get { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); return CurrentRecord.ShipCountryName; }
			set { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); CurrentRecord.ShipCountryName = value; }
		}
		...
		{
			get { return new byte[] { 85, 234, 213, 80, 98, 21, 118, 130, 171, 246, 8, 229, 160, 195, 120, 21 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "55EAD55062157682ABF608E5A0C37815"; }
		}
	...
	public sealed partial class MostRecentOrdersRecord : IRecordBase, INotifyPropertyChanged
	{
		...
		public string OrderStatusName
		{
			...
			set
			{
				if (value == null) throw new ArgumentNullException("OrderStatusName", VenturaSqlStrings.SET_NULL_MSG);
		...
		public string ShipCountryName
		{
			...
			set
			{
				if (value == null) throw new ArgumentNullException("ShipCountryName", VenturaSqlStrings.SET_NULL_MSG);
