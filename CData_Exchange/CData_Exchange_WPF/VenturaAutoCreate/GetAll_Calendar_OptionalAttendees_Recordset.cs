...
namespace WpfApp1.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Calendar_OptionalAttendees_Recordset : ResultsetObservable<GetAll_Calendar_OptionalAttendees_Recordset, GetAll_Calendar_OptionalAttendees_Record>, IRecordsetBase
	{
		...
		public GetAll_Calendar_OptionalAttendees_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT [EmailAddress],[ItemId],[Name]" + CRLF +
			             @"FROM [Exchange].[Calendar_OptionalAttendees]";
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Calendar_OptionalAttendees_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Calendar_OptionalAttendees_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Calendar_OptionalAttendees_Record NewRecord()
		{
			return new GetAll_Calendar_OptionalAttendees_Record();
		}

		protected override GetAll_Calendar_OptionalAttendees_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Calendar_OptionalAttendees_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 129, 105, 187, 96, 18, 168, 110, 185, 77, 211, 84, 85, 139, 118, 97, 112 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "8169BB6012A86EB94DD354558B766170"; }
		}
	...
	public sealed partial class GetAll_Calendar_OptionalAttendees_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Calendar_OptionalAttendees_Record()
		{
		...
		public GetAll_Calendar_OptionalAttendees_Record(object[] columnvalues)
		{
...
namespace WpfApp1.VenturaAutoCreate
{
	public partial class GetAll_Calendar_OptionalAttendees_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
