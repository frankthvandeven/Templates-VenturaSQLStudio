...
namespace WpfApp1.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Calendar_Recordset : ResultsetObservable<GetAll_Calendar_Recordset, GetAll_Calendar_Record>, IRecordsetBase
	{
		...
		public GetAll_Calendar_Recordset()
		{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Calendar_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Calendar_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Calendar_Record NewRecord()
		{
			return new GetAll_Calendar_Record();
		}

		protected override GetAll_Calendar_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Calendar_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 118, 146, 242, 18, 52, 130, 73, 170, 65, 191, 90, 154, 107, 241, 61, 111 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "7692F212348249AA41BF5A9A6BF13D6F"; }
		}
	...
	public sealed partial class GetAll_Calendar_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Calendar_Record(object[] columnvalues)
		{
...
namespace WpfApp1.VenturaAutoCreate
{
	public partial class GetAll_Calendar_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
