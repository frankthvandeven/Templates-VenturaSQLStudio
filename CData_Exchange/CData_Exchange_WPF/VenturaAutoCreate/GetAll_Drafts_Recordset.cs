...
namespace WpfApp1.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Drafts_Recordset : ResultsetObservable<GetAll_Drafts_Recordset, GetAll_Drafts_Record>, IRecordsetBase
	{
		...
		public GetAll_Drafts_Recordset()
		{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Drafts_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Drafts_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Drafts_Record NewRecord()
		{
			return new GetAll_Drafts_Record();
		}

		protected override GetAll_Drafts_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Drafts_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 144, 55, 108, 137, 177, 154, 140, 96, 137, 27, 123, 44, 72, 50, 65, 27 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "90376C89B19A8C60891B7B2C4832411B"; }
		}
	...
	public sealed partial class GetAll_Drafts_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Drafts_Record(object[] columnvalues)
		{
...
namespace WpfApp1.VenturaAutoCreate
{
	public partial class GetAll_Drafts_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
