...
namespace WpfApp1.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Folders_Recordset : ResultsetObservable<GetAll_Folders_Recordset, GetAll_Folders_Record>, IRecordsetBase
	{
		...
		public GetAll_Folders_Recordset()
		{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Folders_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Folders_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Folders_Record NewRecord()
		{
			return new GetAll_Folders_Record();
		}

		protected override GetAll_Folders_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Folders_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 137, 215, 62, 82, 236, 35, 93, 171, 214, 77, 128, 153, 51, 20, 245, 120 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "89D73E52EC235DABD64D80993314F578"; }
		}
	...
	public sealed partial class GetAll_Folders_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Folders_Record(object[] columnvalues)
		{
...
namespace WpfApp1.VenturaAutoCreate
{
	public partial class GetAll_Folders_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
