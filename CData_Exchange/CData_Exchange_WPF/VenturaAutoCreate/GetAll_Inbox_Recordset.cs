...
namespace WpfApp1.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Inbox_Recordset : ResultsetObservable<GetAll_Inbox_Recordset, GetAll_Inbox_Record>, IRecordsetBase
	{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Inbox_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Inbox_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Inbox_Record NewRecord()
		{
			return new GetAll_Inbox_Record();
		}

		protected override GetAll_Inbox_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Inbox_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 91, 195, 141, 229, 162, 2, 24, 228, 203, 131, 186, 110, 216, 57, 103, 200 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "5BC38DE5A20218E4CB83BA6ED83967C8"; }
		}
	...
	public sealed partial class GetAll_Inbox_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Inbox_Record(object[] columnvalues)
		{
...
namespace WpfApp1.VenturaAutoCreate
{
	public partial class GetAll_Inbox_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
