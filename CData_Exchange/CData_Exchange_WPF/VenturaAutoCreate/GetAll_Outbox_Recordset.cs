...
namespace WpfApp1.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Outbox_Recordset : ResultsetObservable<GetAll_Outbox_Recordset, GetAll_Outbox_Record>, IRecordsetBase
	{
		...
		public GetAll_Outbox_Recordset()
		{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Outbox_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Outbox_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Outbox_Record NewRecord()
		{
			return new GetAll_Outbox_Record();
		}

		protected override GetAll_Outbox_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Outbox_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 139, 23, 49, 78, 167, 33, 135, 68, 33, 103, 220, 5, 105, 155, 164, 195 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "8B17314EA72187442167DC05699BA4C3"; }
		}
	...
	public sealed partial class GetAll_Outbox_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Outbox_Record(object[] columnvalues)
		{
...
namespace WpfApp1.VenturaAutoCreate
{
	public partial class GetAll_Outbox_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
