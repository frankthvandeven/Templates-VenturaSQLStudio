...
namespace WpfApp1.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_SentItems_Recordset : ResultsetObservable<GetAll_SentItems_Recordset, GetAll_SentItems_Record>, IRecordsetBase
	{
		...
		public GetAll_SentItems_Recordset()
		{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_SentItems_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_SentItems_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_SentItems_Record NewRecord()
		{
			return new GetAll_SentItems_Record();
		}

		protected override GetAll_SentItems_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_SentItems_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 27, 62, 215, 52, 200, 245, 172, 58, 108, 115, 247, 106, 179, 56, 134, 217 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "1B3ED734C8F5AC3A6C73F76AB33886D9"; }
		}
	...
	public sealed partial class GetAll_SentItems_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_SentItems_Record()
		{
			_cur__ItemId = null;
		...
		public GetAll_SentItems_Record(object[] columnvalues)
		{
...
namespace WpfApp1.VenturaAutoCreate
{
	public partial class GetAll_SentItems_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
