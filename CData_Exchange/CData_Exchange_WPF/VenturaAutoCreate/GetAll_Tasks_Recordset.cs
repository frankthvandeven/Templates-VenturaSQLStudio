...
namespace WpfApp1.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Tasks_Recordset : ResultsetObservable<GetAll_Tasks_Recordset, GetAll_Tasks_Record>, IRecordsetBase
	{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Tasks_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Tasks_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Tasks_Record NewRecord()
		{
			return new GetAll_Tasks_Record();
		}

		protected override GetAll_Tasks_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Tasks_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 243, 106, 251, 78, 105, 141, 231, 68, 192, 4, 172, 25, 76, 110, 48, 132 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "F36AFB4E698DE744C004AC194C6E3084"; }
		}
	...
	public sealed partial class GetAll_Tasks_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Tasks_Record(object[] columnvalues)
		{
...
namespace WpfApp1.VenturaAutoCreate
{
	public partial class GetAll_Tasks_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
