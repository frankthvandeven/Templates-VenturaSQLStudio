...
{
	/// <summary>
	/// The updateable table is [Exchange].[Calendar_OptionalAttendees]. Updateable table column information:
	...
	/// </summary>
	public partial class PriKey_Calendar_OptionalAttendees_Recordset : ResultsetObservable<PriKey_Calendar_OptionalAttendees_Recordset, PriKey_Calendar_OptionalAttendees_Record>, IRecordsetBase
	{
		...
		public PriKey_Calendar_OptionalAttendees_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT [EmailAddress],[ItemId],[Name]" + CRLF +
			             @"FROM [Exchange].[Calendar_OptionalAttendees]" + CRLF +
			...
			schema_array.Add(new VenturaColumn("EmailAddress", typeof(string), true)
			{
				...
				BaseTableName = "Calendar_OptionalAttendees",
			...
			((IResultsetBase)this).UpdateableTablename = "[Exchange].[Calendar_OptionalAttendees]";
		}

		/// <summary>
		/// Database Column Updateable. Table [Exchange].[Calendar_OptionalAttendees]. PrimaryKey. NotReadonly. AllowNull.
		/// EmailAddress
		/// </summary>
		...
		/// <summary>
		/// Database Column Updateable. Table [Exchange].[Calendar_OptionalAttendees]. NotReadonly. AllowNull.
		/// ItemId
		/// </summary>
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_Calendar_OptionalAttendees_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_Calendar_OptionalAttendees_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_Calendar_OptionalAttendees_Record NewRecord()
		{
			return new PriKey_Calendar_OptionalAttendees_Record();
		}

		protected override PriKey_Calendar_OptionalAttendees_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_Calendar_OptionalAttendees_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 34, 249, 181, 102, 180, 210, 42, 123, 203, 41, 12, 12, 184, 44, 74, 134 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "22F9B566B4D22A7BCB290C0CB82C4A86"; }
		}
		...
		public void SetExecSqlParams(string EmailAddress)
		{
			_inputparametervalues[0] = EmailAddress;
		}

		public void ExecSql(string EmailAddress)
		{
			_inputparametervalues[0] = EmailAddress;
			Transactional.ExecSql(VenturaConfig.DefaultConnector, new IRecordsetBase[] { this });
		}

		public void ExecSql(Connector connector, string EmailAddress)
		{
			_inputparametervalues[0] = EmailAddress;
			Transactional.ExecSql(connector, new IRecordsetBase[] { this });
		}

		public async Task ExecSqlAsync(string EmailAddress)
		{
			_inputparametervalues[0] = EmailAddress;
			await Transactional.ExecSqlAsync(VenturaConfig.DefaultConnector, new IRecordsetBase[] { this });
		}

		public async Task ExecSqlAsync(Connector connector, string EmailAddress)
		{
			_inputparametervalues[0] = EmailAddress;
	...
	public sealed partial class PriKey_Calendar_OptionalAttendees_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_Calendar_OptionalAttendees_Record()
		{
		...
		public PriKey_Calendar_OptionalAttendees_Record(object[] columnvalues)
		{
...
namespace WpfApp1.VenturaAutoCreate
{
	public partial class PriKey_Calendar_OptionalAttendees_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
