...
namespace WpfApp1.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class PriKey_Calendar_RequiredAttendees_Recordset : ResultsetObservable<PriKey_Calendar_RequiredAttendees_Recordset, PriKey_Calendar_RequiredAttendees_Record>, IRecordsetBase
	{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_Calendar_RequiredAttendees_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_Calendar_RequiredAttendees_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_Calendar_RequiredAttendees_Record NewRecord()
		{
			return new PriKey_Calendar_RequiredAttendees_Record();
		}

		protected override PriKey_Calendar_RequiredAttendees_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_Calendar_RequiredAttendees_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 79, 191, 149, 133, 160, 155, 199, 134, 148, 176, 222, 14, 17, 232, 15, 219 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "4FBF9585A09BC78694B0DE0E11E80FDB"; }
		}
	...
	public sealed partial class PriKey_Calendar_RequiredAttendees_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_Calendar_RequiredAttendees_Record()
		{
		...
		public PriKey_Calendar_RequiredAttendees_Record(object[] columnvalues)
		{
...
namespace WpfApp1.VenturaAutoCreate
{
	public partial class PriKey_Calendar_RequiredAttendees_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
