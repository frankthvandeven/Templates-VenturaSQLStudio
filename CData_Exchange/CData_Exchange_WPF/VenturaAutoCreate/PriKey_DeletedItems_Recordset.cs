...
{
	/// <summary>
	/// The updateable table is [Exchange].[DeletedItems]. Updateable table column information:
	...
	/// </summary>
	public partial class PriKey_DeletedItems_Recordset : ResultsetObservable<PriKey_DeletedItems_Recordset, PriKey_DeletedItems_Record>, IRecordsetBase
	{
		...
		public PriKey_DeletedItems_Recordset()
		{
			...
			_sqlscript = @"SELECT [ItemId],[MimeContent],[ItemChangeKey],[ParentFolderId],[ParentFolderChangeKey],[ItemClass],[Subject],[Sensitivity],[Body],[AttachmentIds],[AttachmentNames]," + CRLF +
			             ...
			             @"FROM [Exchange].[DeletedItems]" + CRLF +
			             @"WHERE [ItemId] = @ItemId";
			...
			((IResultsetBase)this).UpdateableTablename = "[Exchange].[DeletedItems]";
		}

		/// <summary>
		/// Database Column NotUpdateable. Table [Exchange].[DeletedItems]. PrimaryKey. Readonly. AllowNull.
		...
		/// <summary>
		/// Database Column NotUpdateable. Table [Exchange].[DeletedItems]. Readonly. AllowNull.
		...
		/// <summary>
		/// Database Column Updateable. Table [Exchange].[DeletedItems]. NotReadonly. AllowNull.
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_DeletedItems_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_DeletedItems_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_DeletedItems_Record NewRecord()
		{
			return new PriKey_DeletedItems_Record();
		}

		protected override PriKey_DeletedItems_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_DeletedItems_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 23, 183, 169, 84, 91, 167, 185, 120, 189, 132, 160, 82, 197, 58, 26, 10 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "17B7A9545BA7B978BD84A052C53A1A0A"; }
		}
	...
	public sealed partial class PriKey_DeletedItems_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_DeletedItems_Record()
		{
			_cur__ItemId = null;
		...
		public PriKey_DeletedItems_Record(object[] columnvalues)
		{
...
namespace WpfApp1.VenturaAutoCreate
{
	public partial class PriKey_DeletedItems_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
