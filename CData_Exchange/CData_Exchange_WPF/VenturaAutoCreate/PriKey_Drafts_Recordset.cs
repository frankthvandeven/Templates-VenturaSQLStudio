...
{
	/// <summary>
	/// The updateable table is [Exchange].[Drafts]. Updateable table column information:
	...
	/// </summary>
	public partial class PriKey_Drafts_Recordset : ResultsetObservable<PriKey_Drafts_Recordset, PriKey_Drafts_Record>, IRecordsetBase
	{
		...
		public PriKey_Drafts_Recordset()
		{
			...
			((IResultsetBase)this).UpdateableTablename = "[Exchange].[Drafts]";
		}

		/// <summary>
		/// Database Column NotUpdateable. Table [Exchange].[Drafts]. PrimaryKey. Readonly. AllowNull.
		...
		/// <summary>
		/// Database Column NotUpdateable. Table [Exchange].[Drafts]. Readonly. AllowNull.
		...
		/// <summary>
		/// Database Column Updateable. Table [Exchange].[Drafts]. NotReadonly. AllowNull.
		...
		/// <summary>
		/// Database Column NotUpdateable. Table [Exchange].[Drafts]. Readonly. AllowNull.
		/// Represents the display string that is used for the contents of the Cc box. This is the concatenated string of all To
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_Drafts_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_Drafts_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_Drafts_Record NewRecord()
		{
			return new PriKey_Drafts_Record();
		}

		protected override PriKey_Drafts_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_Drafts_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 126, 242, 245, 95, 168, 234, 44, 251, 125, 135, 134, 0, 40, 202, 103, 18 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "7EF2F55FA8EA2CFB7D87860028CA6712"; }
		}
	...
	public sealed partial class PriKey_Drafts_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_Drafts_Record(object[] columnvalues)
		{
...
namespace WpfApp1.VenturaAutoCreate
{
	public partial class PriKey_Drafts_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
