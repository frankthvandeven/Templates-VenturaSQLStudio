...
namespace WpfApp1.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class PriKey_JunkEmail_Recordset : ResultsetObservable<PriKey_JunkEmail_Recordset, PriKey_JunkEmail_Record>, IRecordsetBase
	{
		...
		public PriKey_JunkEmail_Recordset()
		{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_JunkEmail_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_JunkEmail_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_JunkEmail_Record NewRecord()
		{
			return new PriKey_JunkEmail_Record();
		}

		protected override PriKey_JunkEmail_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_JunkEmail_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 17, 197, 182, 112, 0, 167, 235, 132, 56, 60, 80, 102, 101, 55, 232, 35 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "11C5B67000A7EB84383C50666537E823"; }
		}
	...
	public sealed partial class PriKey_JunkEmail_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_JunkEmail_Record()
		{
			_cur__ItemId = null;
		...
		public PriKey_JunkEmail_Record(object[] columnvalues)
		{
...
namespace WpfApp1.VenturaAutoCreate
{
	public partial class PriKey_JunkEmail_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
