...
{
	/// <summary>
	/// The updateable table is [Exchange].[Outbox]. Updateable table column information:
	...
	/// </summary>
	public partial class PriKey_Outbox_Recordset : ResultsetObservable<PriKey_Outbox_Recordset, PriKey_Outbox_Record>, IRecordsetBase
	{
		...
		public PriKey_Outbox_Recordset()
		{
			...
			((IResultsetBase)this).UpdateableTablename = "[Exchange].[Outbox]";
		}

		/// <summary>
		/// Database Column NotUpdateable. Table [Exchange].[Outbox]. PrimaryKey. Readonly. AllowNull.
		...
		/// <summary>
		/// Database Column NotUpdateable. Table [Exchange].[Outbox]. Readonly. AllowNull.
		...
		/// <summary>
		/// Database Column Updateable. Table [Exchange].[Outbox]. NotReadonly. AllowNull.
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_Outbox_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_Outbox_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_Outbox_Record NewRecord()
		{
			return new PriKey_Outbox_Record();
		}

		protected override PriKey_Outbox_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_Outbox_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 92, 97, 97, 228, 241, 115, 151, 42, 15, 56, 251, 146, 236, 42, 62, 238 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "5C6161E4F173972A0F38FB92EC2A3EEE"; }
		}
	...
	public sealed partial class PriKey_Outbox_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_Outbox_Record(object[] columnvalues)
		{
...
namespace WpfApp1.VenturaAutoCreate
{
	public partial class PriKey_Outbox_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
