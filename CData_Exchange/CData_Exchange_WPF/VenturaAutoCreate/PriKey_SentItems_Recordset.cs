...
{
	/// <summary>
	/// The updateable table is [Exchange].[SentItems]. Updateable table column information:
	...
	/// </summary>
	public partial class PriKey_SentItems_Recordset : ResultsetObservable<PriKey_SentItems_Recordset, PriKey_SentItems_Record>, IRecordsetBase
	{
		...
		public PriKey_SentItems_Recordset()
		{
			...
			((IResultsetBase)this).UpdateableTablename = "[Exchange].[SentItems]";
		}

		/// <summary>
		/// Database Column NotUpdateable. Table [Exchange].[SentItems]. PrimaryKey. Readonly. AllowNull.
		...
		/// <summary>
		/// Database Column NotUpdateable. Table [Exchange].[SentItems]. Readonly. AllowNull.
		...
		/// <summary>
		/// Database Column Updateable. Table [Exchange].[SentItems]. NotReadonly. AllowNull.
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_SentItems_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_SentItems_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_SentItems_Record NewRecord()
		{
			return new PriKey_SentItems_Record();
		}

		protected override PriKey_SentItems_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_SentItems_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 86, 131, 212, 191, 3, 241, 18, 66, 55, 97, 109, 233, 247, 156, 155, 183 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "5683D4BF03F1124237616DE9F79C9BB7"; }
		}
	...
	public sealed partial class PriKey_SentItems_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_SentItems_Record()
		{
			_cur__ItemId = null;
		...
		public PriKey_SentItems_Record(object[] columnvalues)
		{
...
namespace WpfApp1.VenturaAutoCreate
{
	public partial class PriKey_SentItems_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
