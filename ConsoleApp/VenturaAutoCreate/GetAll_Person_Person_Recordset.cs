...
namespace ConsoleApp.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Person_Person_Recordset : ResultsetObservable<GetAll_Person_Person_Recordset, GetAll_Person_Person_Record>, IRecordsetBase
	{
		...
		public GetAll_Person_Person_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [BusinessEntityID],[PersonType],[NameStyle],[Title],[FirstName],[MiddleName],[LastName],[Suffix],[EmailPromotion],[AdditionalContactInfo]," + CRLF +
			             @"[Demographics],[rowguid],[ModifiedDate]" + CRLF +
			             @"FROM [Person].[Person]";
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Person_Person_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Person_Person_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Person_Person_Record NewRecord()
		{
			return new GetAll_Person_Person_Record();
		}

		protected override GetAll_Person_Person_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Person_Person_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 133, 115, 227, 140, 167, 20, 15, 177, 37, 187, 87, 53, 87, 85, 135, 20 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "8573E38CA7140FB125BB573557558714"; }
		}
	...
	public sealed partial class GetAll_Person_Person_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Person_Person_Record()
		{
		...
		public GetAll_Person_Person_Record(object[] columnvalues)
		{
...
namespace ConsoleApp.VenturaAutoCreate
{
	public partial class GetAll_Person_Person_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
