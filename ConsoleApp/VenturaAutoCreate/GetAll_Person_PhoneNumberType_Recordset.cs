/*
	...
	Generated on: Wednesday, 12 May 2021 at 18:50:24
...
{
	/// <summary>
	/// The updateable table is [Person].[PhoneNumberType]. Updateable table column information:
	/// • 3 out of 3 table columns are present in the resultset.
	/// • All primary key columns are present in the resultset: PhoneNumberTypeID.
	/// • Non-primary key columns present in the resultset: Name and ModifiedDate.
	/// Recordset item automatically created by VenturaSQL Studio.
	/// </summary>
	public partial class GetAll_Person_PhoneNumberType_Recordset : ResultsetObservable<GetAll_Person_PhoneNumberType_Recordset, GetAll_Person_PhoneNumberType_Record>, IRecordsetBase
	{
		...
		public GetAll_Person_PhoneNumberType_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [PhoneNumberTypeID],[Name],[ModifiedDate]" + CRLF +
		...
		/// <summary>
		/// Database Column NotUpdateable. Table [Person].[PhoneNumberType]. PrimaryKey. NotReadonly. NotNull. IsIdentity. AutoIncrement.
		/// </summary>
		...
		/// <summary>
		/// Database Column Updateable. Table [Person].[PhoneNumberType]. NotReadonly. NotNull.
		/// </summary>
		public string Name
		{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Person_PhoneNumberType_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Person_PhoneNumberType_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Person_PhoneNumberType_Record NewRecord()
		{
			return new GetAll_Person_PhoneNumberType_Record();
		}

		protected override GetAll_Person_PhoneNumberType_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Person_PhoneNumberType_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 36, 197, 81, 9, 226, 48, 221, 198, 88, 152, 109, 167, 48, 180, 61, 52 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "24C55109E230DDC658986DA730B43D34"; }
		}
		...
		{
			get { return new DateTime(2021, 5, 12, 18, 50, 24); } // Wednesday, 12 May 2021 at 18:50:24
		}
	...
	public sealed partial class GetAll_Person_PhoneNumberType_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Person_PhoneNumberType_Record()
		{
		...
		public GetAll_Person_PhoneNumberType_Record(object[] columnvalues)
		{
			_cur__PhoneNumberTypeID = (int)columnvalues[0];
		...
		void IRecordBase.WriteChangesToTrackArray(TrackArray track_array)
		{
			...
			{
				track_array.AppendPrikeyValue(0, (_mod__PhoneNumberTypeID && _started_with_dbvalues) ? _ori__PhoneNumberTypeID : _cur__PhoneNumberTypeID);
			}
		...
		{
			_cur__PhoneNumberTypeID = (int)value;
			OnPropertyChanged("PhoneNumberTypeID");
			OnAfterPropertyChanged("PhoneNumberTypeID");
		}
...
namespace ConsoleApp.VenturaAutoCreate
{
	public partial class GetAll_Person_PhoneNumberType_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
