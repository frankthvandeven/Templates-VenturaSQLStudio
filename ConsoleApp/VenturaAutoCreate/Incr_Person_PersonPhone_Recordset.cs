...
namespace ConsoleApp.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class Incr_Person_PersonPhone_Recordset : ResultsetObservable<Incr_Person_PersonPhone_Recordset, Incr_Person_PersonPhone_Record>, IRecordsetBase, IRecordsetIncremental
	{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new Incr_Person_PersonPhone_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(Incr_Person_PersonPhone_Record record)
		{
			int index = this.RecordCount;
		...
		public Incr_Person_PersonPhone_Record NewRecord()
		{
			return new Incr_Person_PersonPhone_Record();
		}

		protected override Incr_Person_PersonPhone_Record InternalCreateExistingRecordObject(object[] columnvalues) => new Incr_Person_PersonPhone_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 182, 161, 8, 209, 211, 120, 120, 167, 2, 50, 75, 245, 255, 168, 169, 18 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "B6A108D1D37878A702324BF5FFA8A912"; }
		}
	...
	public sealed partial class Incr_Person_PersonPhone_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public Incr_Person_PersonPhone_Record()
		{
		...
		public Incr_Person_PersonPhone_Record(object[] columnvalues)
		{
...
namespace ConsoleApp.VenturaAutoCreate
{
	public partial class Incr_Person_PersonPhone_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
