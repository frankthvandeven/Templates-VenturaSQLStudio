...
namespace ConsoleApp.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class Incr_Person_Person_Recordset : ResultsetObservable<Incr_Person_Person_Recordset, Incr_Person_Person_Record>, IRecordsetBase, IRecordsetIncremental
	{
		...
		public Incr_Person_Person_Recordset()
		{
			...
			_sqlscript = @"SELECT [BusinessEntityID],[PersonType],[NameStyle],[Title],[FirstName],[MiddleName],[LastName],[Suffix],[EmailPromotion],[AdditionalContactInfo],[Demographics]," + CRLF +
			             ...
			             @"ORDER BY [BusinessEntityID]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new Incr_Person_Person_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(Incr_Person_Person_Record record)
		{
			int index = this.RecordCount;
		...
		public Incr_Person_Person_Record NewRecord()
		{
			return new Incr_Person_Person_Record();
		}

		protected override Incr_Person_Person_Record InternalCreateExistingRecordObject(object[] columnvalues) => new Incr_Person_Person_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 153, 54, 169, 162, 123, 239, 99, 98, 217, 49, 196, 142, 3, 120, 120, 24 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "9936A9A27BEF6362D931C48E03787818"; }
		}
	...
	public sealed partial class Incr_Person_Person_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public Incr_Person_Person_Record()
		{
		...
		public Incr_Person_Person_Record(object[] columnvalues)
		{
...
namespace ConsoleApp.VenturaAutoCreate
{
	public partial class Incr_Person_Person_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
