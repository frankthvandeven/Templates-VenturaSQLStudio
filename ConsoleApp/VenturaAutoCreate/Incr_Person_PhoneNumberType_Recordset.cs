...
namespace ConsoleApp.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class Incr_Person_PhoneNumberType_Recordset : ResultsetObservable<Incr_Person_PhoneNumberType_Recordset, Incr_Person_PhoneNumberType_Record>, IRecordsetBase, IRecordsetIncremental
	{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new Incr_Person_PhoneNumberType_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(Incr_Person_PhoneNumberType_Record record)
		{
			int index = this.RecordCount;
		...
		public Incr_Person_PhoneNumberType_Record NewRecord()
		{
			return new Incr_Person_PhoneNumberType_Record();
		}

		protected override Incr_Person_PhoneNumberType_Record InternalCreateExistingRecordObject(object[] columnvalues) => new Incr_Person_PhoneNumberType_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 192, 65, 36, 6, 43, 61, 217, 93, 147, 118, 131, 227, 202, 135, 57, 74 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "C04124062B3DD95D937683E3CA87394A"; }
		}
	...
	public sealed partial class Incr_Person_PhoneNumberType_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public Incr_Person_PhoneNumberType_Record()
		{
		...
		public Incr_Person_PhoneNumberType_Record(object[] columnvalues)
		{
...
namespace ConsoleApp.VenturaAutoCreate
{
	public partial class Incr_Person_PhoneNumberType_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
