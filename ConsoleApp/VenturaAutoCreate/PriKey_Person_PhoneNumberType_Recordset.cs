...
namespace ConsoleApp.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class PriKey_Person_PhoneNumberType_Recordset : ResultsetObservable<PriKey_Person_PhoneNumberType_Recordset, PriKey_Person_PhoneNumberType_Record>, IRecordsetBase
	{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_Person_PhoneNumberType_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_Person_PhoneNumberType_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_Person_PhoneNumberType_Record NewRecord()
		{
			return new PriKey_Person_PhoneNumberType_Record();
		}

		protected override PriKey_Person_PhoneNumberType_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_Person_PhoneNumberType_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 225, 245, 128, 85, 136, 0, 55, 87, 156, 91, 221, 105, 244, 35, 89, 44 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "E1F58055880037579C5BDD69F423592C"; }
		}
		...
		public void SetExecSqlParams(int? PhoneNumberTypeID)
		{
	...
	public sealed partial class PriKey_Person_PhoneNumberType_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_Person_PhoneNumberType_Record()
		{
		...
		public PriKey_Person_PhoneNumberType_Record(object[] columnvalues)
		{
...
namespace ConsoleApp.VenturaAutoCreate
{
	public partial class PriKey_Person_PhoneNumberType_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
