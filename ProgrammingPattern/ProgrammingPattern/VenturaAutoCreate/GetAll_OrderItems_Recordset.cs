...
namespace ProgrammingPattern.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_OrderItems_Recordset : ResultsetObservable<GetAll_OrderItems_Recordset, GetAll_OrderItems_Record>, IRecordsetBase
	{
		...
		public GetAll_OrderItems_Recordset()
		{
			...
			_sqlscript = @"SELECT [OrderID],[OrderLine],[Discount],[ProductID],[Quantity],[TaxType],[UnitPrice]" + CRLF +
			             @"FROM [OrderItems] LIMIT @RowLimit";
		...
		{
			get { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); return CurrentRecord.OrderLine; }
			set { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); CurrentRecord.OrderLine = value; }
		}
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_OrderItems_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_OrderItems_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_OrderItems_Record NewRecord()
		{
			return new GetAll_OrderItems_Record();
		}

		protected override GetAll_OrderItems_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_OrderItems_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 181, 198, 88, 175, 145, 180, 48, 10, 156, 34, 103, 201, 151, 3, 37, 76 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "B5C658AF91B4300A9C2267C99703254C"; }
		}
	...
	public sealed partial class GetAll_OrderItems_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_OrderItems_Record()
		{
			_cur__OrderID = 0;
			_cur__OrderLine = 0;
			_cur__Discount = "";
		...
		public GetAll_OrderItems_Record(object[] columnvalues)
		{
		...
		public string UnitPrice
		{
			...
			set
			{
				if (value == null) throw new ArgumentNullException("UnitPrice", VenturaSqlStrings.SET_NULL_MSG);
		...
		void IRecordBase.ValidateBeforeSaving(int record_index_to_display)
		{
			...
			if (_mod__OrderLine == false) throw new Exception(string.Format(VenturaSqlStrings.VALUE_NOT_SET_MSG, record_index_to_display, "OrderLine"));
		}
...
namespace ProgrammingPattern.VenturaAutoCreate
{
	public partial class GetAll_OrderItems_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
