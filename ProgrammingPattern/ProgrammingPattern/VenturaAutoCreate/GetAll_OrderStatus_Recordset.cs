...
namespace ProgrammingPattern.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_OrderStatus_Recordset : ResultsetObservable<GetAll_OrderStatus_Recordset, GetAll_OrderStatus_Record>, IRecordsetBase
	{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_OrderStatus_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_OrderStatus_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_OrderStatus_Record NewRecord()
		{
			return new GetAll_OrderStatus_Record();
		}

		protected override GetAll_OrderStatus_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_OrderStatus_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 235, 246, 223, 34, 145, 172, 112, 170, 105, 233, 7, 77, 76, 33, 242, 17 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "EBF6DF2291AC70AA69E9074D4C21F211"; }
		}
	...
	public sealed partial class GetAll_OrderStatus_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_OrderStatus_Record()
		{
			_cur__Status = 0;
			_cur__Name = "";
		...
		public GetAll_OrderStatus_Record(object[] columnvalues)
		{
...
namespace ProgrammingPattern.VenturaAutoCreate
{
	public partial class GetAll_OrderStatus_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
