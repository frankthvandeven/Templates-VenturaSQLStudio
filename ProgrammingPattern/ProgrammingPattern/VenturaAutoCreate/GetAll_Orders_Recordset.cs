...
namespace ProgrammingPattern.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Orders_Recordset : ResultsetObservable<GetAll_Orders_Recordset, GetAll_Orders_Record>, IRecordsetBase
	{
		...
		public GetAll_Orders_Recordset()
		{
			...
			schema_array.Add(new VenturaSqlColumn("DeliveredDate", typeof(string), true)
			{
				Updateable = true,
				ProviderType = 16,
				BaseCatalogName = "main",
			...
			schema_array.Add(new VenturaSqlColumn("PaymentType", typeof(long), true)
			{
				Updateable = true,
				ColumnSize = 8,
				NumericPrecision = 19,
			...
			schema_array.Add(new VenturaSqlColumn("ShipCountryCode", typeof(string), true)
			{
				Updateable = true,
				ProviderType = 16,
				BaseCatalogName = "main",
			...
			schema_array.Add(new VenturaSqlColumn("ShipPhone", typeof(string), true)
			{
				Updateable = true,
				ProviderType = 16,
				BaseCatalogName = "main",
			...
			schema_array.Add(new VenturaSqlColumn("ShipPostalCode", typeof(string), true)
			{
				Updateable = true,
				ProviderType = 16,
				BaseCatalogName = "main",
			...
			schema_array.Add(new VenturaSqlColumn("ShipRegion", typeof(string), true)
			{
				Updateable = true,
				ProviderType = 16,
				BaseCatalogName = "main",
			...
			schema_array.Add(new VenturaSqlColumn("ShipVia", typeof(long), true)
			{
				Updateable = true,
				ColumnSize = 8,
				NumericPrecision = 19,
			...
			schema_array.Add(new VenturaSqlColumn("ShippedDate", typeof(string), true)
			{
				Updateable = true,
				ProviderType = 16,
				BaseCatalogName = "main",
			...
			schema_array.Add(new VenturaSqlColumn("TrackingNumber", typeof(string), true)
			{
				Updateable = true,
				ProviderType = 16,
				BaseCatalogName = "main",
		...
		{
			get { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); return CurrentRecord.DeliveredDate; }
			set { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); CurrentRecord.DeliveredDate = value; }
		}
		...
		{
			get { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); return CurrentRecord.PaymentType; }
			set { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); CurrentRecord.PaymentType = value; }
		}
		...
		{
			get { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); return CurrentRecord.ShipCountryCode; }
			set { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); CurrentRecord.ShipCountryCode = value; }
		}
		...
		{
			get { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); return CurrentRecord.ShipPhone; }
			set { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); CurrentRecord.ShipPhone = value; }
		}
		...
		{
			get { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); return CurrentRecord.ShipPostalCode; }
			set { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); CurrentRecord.ShipPostalCode = value; }
		}
		...
		{
			get { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); return CurrentRecord.ShipRegion; }
			set { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); CurrentRecord.ShipRegion = value; }
		}
		...
		public long? ShipVia
		{
			get { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); return CurrentRecord.ShipVia; }
			set { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); CurrentRecord.ShipVia = value; }
		}
		...
		{
			get { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); return CurrentRecord.ShippedDate; }
			set { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); CurrentRecord.ShippedDate = value; }
		}
		...
		{
			get { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); return CurrentRecord.TrackingNumber; }
			set { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); CurrentRecord.TrackingNumber = value; }
		}
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Orders_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Orders_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Orders_Record NewRecord()
		{
			return new GetAll_Orders_Record();
		}

		protected override GetAll_Orders_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Orders_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 110, 2, 249, 7, 63, 145, 202, 176, 197, 66, 105, 52, 58, 217, 196, 40 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "6E02F9073F91CAB0C54269343AD9C428"; }
		}
	...
	public sealed partial class GetAll_Orders_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Orders_Record(object[] columnvalues)
		{
...
namespace ProgrammingPattern.VenturaAutoCreate
{
	public partial class GetAll_Orders_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
