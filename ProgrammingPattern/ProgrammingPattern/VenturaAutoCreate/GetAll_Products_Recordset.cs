...
namespace ProgrammingPattern.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Products_Recordset : ResultsetObservable<GetAll_Products_Recordset, GetAll_Products_Record>, IRecordsetBase
	{
		...
		public GetAll_Products_Recordset()
		{
			...
			schema_array.Add(new VenturaSqlColumn("DealerPrice", typeof(string), false)
			{
				Updateable = true,
				ProviderType = 16,
				BaseCatalogName = "main",
			...
			schema_array.Add(new VenturaSqlColumn("DiscountEndDate", typeof(string), true)
			{
				Updateable = true,
				ProviderType = 16,
				BaseCatalogName = "main",
			...
			schema_array.Add(new VenturaSqlColumn("DiscountStartDate", typeof(string), true)
			{
				Updateable = true,
				ProviderType = 16,
				BaseCatalogName = "main",
			...
			schema_array.Add(new VenturaSqlColumn("ListPrice", typeof(string), false)
			{
				Updateable = true,
				ProviderType = 16,
				BaseCatalogName = "main",
			...
			schema_array.Add(new VenturaSqlColumn("SafetyStockLevel", typeof(long), false)
			{
				Updateable = true,
				ColumnSize = 8,
				NumericPrecision = 19,
			...
			schema_array.Add(new VenturaSqlColumn("StockUnits", typeof(long), false)
			{
				Updateable = true,
				ColumnSize = 8,
				NumericPrecision = 19,
		...
		{
			get { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); return CurrentRecord.DealerPrice; }
			set { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); CurrentRecord.DealerPrice = value; }
		}
		...
		{
			get { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); return CurrentRecord.DiscountEndDate; }
			set { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); CurrentRecord.DiscountEndDate = value; }
		}
		...
		{
			get { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); return CurrentRecord.DiscountStartDate; }
			set { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); CurrentRecord.DiscountStartDate = value; }
		}
		...
		{
			get { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); return CurrentRecord.StockUnits; }
			set { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); CurrentRecord.StockUnits = value; }
		}
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Products_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Products_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Products_Record NewRecord()
		{
			return new GetAll_Products_Record();
		}

		protected override GetAll_Products_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Products_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 13, 155, 255, 248, 118, 3, 207, 155, 122, 211, 175, 39, 135, 52, 205, 245 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "0D9BFFF87603CF9B7AD3AF278734CDF5"; }
		}
	...
	public sealed partial class GetAll_Products_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Products_Record(object[] columnvalues)
		{
			...
			_cur__Picture = (byte[])columnvalues[12];
			...
			_cur__Thumbnail = (byte[])columnvalues[18];
		...
		public string ProductID
		{
			...
			set
			{
				if (value == null) throw new ArgumentNullException("ProductID", VenturaSqlStrings.SET_NULL_MSG);
		...
		public string DealerPrice
		{
			...
			set
			{
				if (value == null) throw new ArgumentNullException("DealerPrice", VenturaSqlStrings.SET_NULL_MSG);
		...
		public string Discount
		{
			...
			set
			{
				if (value == null) throw new ArgumentNullException("Discount", VenturaSqlStrings.SET_NULL_MSG);
		...
		public string ListPrice
		{
			...
			set
			{
				if (value == null) throw new ArgumentNullException("ListPrice", VenturaSqlStrings.SET_NULL_MSG);
...
namespace ProgrammingPattern.VenturaAutoCreate
{
	public partial class GetAll_Products_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
