...
namespace ProgrammingPattern.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class PriKey_Categories_Recordset : ResultsetObservable<PriKey_Categories_Recordset, PriKey_Categories_Record>, IRecordsetBase
	{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_Categories_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_Categories_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_Categories_Record NewRecord()
		{
			return new PriKey_Categories_Record();
		}

		protected override PriKey_Categories_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_Categories_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 162, 109, 18, 27, 129, 218, 197, 169, 171, 45, 66, 87, 130, 130, 12, 62 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "A26D121B81DAC5A9AB2D425782820C3E"; }
		}
		...
		public void SetExecSqlParams(long? CategoryID)
		{
			_inputparametervalues[0] = CategoryID;
		}

		public void ExecSql(long? CategoryID)
		{
			_inputparametervalues[0] = CategoryID;
			Transactional.ExecSql(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
		}

		public void ExecSql(Connector connector, long? CategoryID)
		{
			_inputparametervalues[0] = CategoryID;
			Transactional.ExecSql(connector, new IRecordsetBase[] { this });
		}

		public async Task ExecSqlAsync(long? CategoryID)
		{
			_inputparametervalues[0] = CategoryID;
			await Transactional.ExecSqlAsync(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
		}

		public async Task ExecSqlAsync(Connector connector, long? CategoryID)
		{
			_inputparametervalues[0] = CategoryID;
	...
	public sealed partial class PriKey_Categories_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_Categories_Record()
		{
			_cur__CategoryID = 0;
		...
		public PriKey_Categories_Record(object[] columnvalues)
		{
...
namespace ProgrammingPattern.VenturaAutoCreate
{
	public partial class PriKey_Categories_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
