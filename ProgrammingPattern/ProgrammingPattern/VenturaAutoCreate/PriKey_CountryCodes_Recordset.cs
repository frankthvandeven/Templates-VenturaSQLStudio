...
namespace ProgrammingPattern.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class PriKey_CountryCodes_Recordset : ResultsetObservable<PriKey_CountryCodes_Recordset, PriKey_CountryCodes_Record>, IRecordsetBase
	{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_CountryCodes_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_CountryCodes_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_CountryCodes_Record NewRecord()
		{
			return new PriKey_CountryCodes_Record();
		}

		protected override PriKey_CountryCodes_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_CountryCodes_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 171, 179, 194, 57, 117, 99, 193, 95, 185, 246, 233, 240, 193, 166, 140, 208 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "ABB3C2397563C15FB9F6E9F0C1A68CD0"; }
		}
		...
		public void SetExecSqlParams(string CountryCodeID)
		{
			_inputparametervalues[0] = CountryCodeID;
		}

		public void ExecSql(string CountryCodeID)
		{
			_inputparametervalues[0] = CountryCodeID;
			Transactional.ExecSql(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
		}

		public void ExecSql(Connector connector, string CountryCodeID)
		{
			_inputparametervalues[0] = CountryCodeID;
			Transactional.ExecSql(connector, new IRecordsetBase[] { this });
		}

		public async Task ExecSqlAsync(string CountryCodeID)
		{
			_inputparametervalues[0] = CountryCodeID;
			await Transactional.ExecSqlAsync(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
		}

		public async Task ExecSqlAsync(Connector connector, string CountryCodeID)
		{
			_inputparametervalues[0] = CountryCodeID;
	...
	public sealed partial class PriKey_CountryCodes_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_CountryCodes_Record()
		{
			_cur__CountryCodeID = "";
			_cur__Name = "";
		...
		public PriKey_CountryCodes_Record(object[] columnvalues)
		{
...
namespace ProgrammingPattern.VenturaAutoCreate
{
	public partial class PriKey_CountryCodes_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
