/*
	...
	Generated on: Wednesday, 19 May 2021 at 09:12:09
...
namespace ProgrammingPattern.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class PriKey_Customers_Recordset : ResultsetObservable<PriKey_Customers_Recordset, PriKey_Customers_Record>, IRecordsetBase
	{
		...
		public PriKey_Customers_Recordset()
		{
			...
			param_array.AddParameterColumn("@CustomerID", typeof(long), true, false, DbType.Int64, null, null, null);
			...
			schema_array.Add(new VenturaSqlColumn("BirthDate", typeof(string), true)
			{
				Updateable = true,
				ProviderType = 16,
				BaseCatalogName = "main",
			...
			schema_array.Add(new VenturaSqlColumn("ChildrenAtHome", typeof(long), true)
			{
				Updateable = true,
				ColumnSize = 8,
				NumericPrecision = 19,
			...
			schema_array.Add(new VenturaSqlColumn("CountryCode", typeof(string), false)
			{
				Updateable = true,
				ProviderType = 16,
				BaseCatalogName = "main",
			...
			schema_array.Add(new VenturaSqlColumn("CreatedOn", typeof(string), false)
			{
				Updateable = true,
				ProviderType = 16,
				BaseCatalogName = "main",
			...
			schema_array.Add(new VenturaSqlColumn("Education", typeof(string), true)
			{
				Updateable = true,
				ProviderType = 16,
				BaseCatalogName = "main",
			...
			schema_array.Add(new VenturaSqlColumn("Gender", typeof(string), true)
			{
				Updateable = true,
				ProviderType = 16,
				BaseCatalogName = "main",
			...
			schema_array.Add(new VenturaSqlColumn("IsHouseOwner", typeof(long), true)
			{
				Updateable = true,
				ColumnSize = 8,
				NumericPrecision = 19,
			...
			schema_array.Add(new VenturaSqlColumn("LastModifiedOn", typeof(string), false)
			{
				Updateable = true,
				ProviderType = 16,
				BaseCatalogName = "main",
			...
			schema_array.Add(new VenturaSqlColumn("MaritalStatus", typeof(string), true)
			{
				Updateable = true,
				ProviderType = 16,
				BaseCatalogName = "main",
			...
			schema_array.Add(new VenturaSqlColumn("NumberCarsOwned", typeof(long), true)
			{
				Updateable = true,
				ColumnSize = 8,
				NumericPrecision = 19,
			...
			schema_array.Add(new VenturaSqlColumn("Occupation", typeof(string), true)
			{
				Updateable = true,
				ProviderType = 16,
				BaseCatalogName = "main",
			...
			schema_array.Add(new VenturaSqlColumn("Region", typeof(string), false)
			{
				Updateable = true,
				ProviderType = 16,
				BaseCatalogName = "main",
			...
			schema_array.Add(new VenturaSqlColumn("SearchTerms", typeof(string), true)
			{
				Updateable = true,
				ProviderType = 16,
				BaseCatalogName = "main",
			...
			schema_array.Add(new VenturaSqlColumn("TotalChildren", typeof(long), true)
			{
				Updateable = true,
				ColumnSize = 8,
				NumericPrecision = 19,
			...
			schema_array.Add(new VenturaSqlColumn("YearlyIncome", typeof(string), true)
			{
				Updateable = true,
				ProviderType = 16,
				BaseCatalogName = "main",
		...
		{
			get { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); return CurrentRecord.ChildrenAtHome; }
			set { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); CurrentRecord.ChildrenAtHome = value; }
		}
		...
		{
			get { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); return CurrentRecord.CountryCode; }
			set { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); CurrentRecord.CountryCode = value; }
		}
		...
		{
			get { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); return CurrentRecord.CreatedOn; }
			set { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); CurrentRecord.CreatedOn = value; }
		}
		...
		{
			get { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); return CurrentRecord.Education; }
			set { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); CurrentRecord.Education = value; }
		}
		...
		{
			get { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); return CurrentRecord.IsHouseOwner; }
			set { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); CurrentRecord.IsHouseOwner = value; }
		}
		...
		{
			get { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); return CurrentRecord.LastModifiedOn; }
			set { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); CurrentRecord.LastModifiedOn = value; }
		}
		...
		{
			get { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); return CurrentRecord.NumberCarsOwned; }
			set { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); CurrentRecord.NumberCarsOwned = value; }
		}
		...
		{
			get { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); return CurrentRecord.Occupation; }
			set { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); CurrentRecord.Occupation = value; }
		}
		...
		{
			get { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); return CurrentRecord.Region; }
			set { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); CurrentRecord.Region = value; }
		}
		...
		{
			get { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); return CurrentRecord.SearchTerms; }
			set { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); CurrentRecord.SearchTerms = value; }
		}
		...
		{
			get { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); return CurrentRecord.TotalChildren; }
			set { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); CurrentRecord.TotalChildren = value; }
		}
		...
		{
			get { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); return CurrentRecord.YearlyIncome; }
			set { if (CurrentRecord == null) throw new InvalidOperationException(VenturaSqlStrings.CURRENT_RECORD_NOT_SET); CurrentRecord.YearlyIncome = value; }
		}
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_Customers_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_Customers_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_Customers_Record NewRecord()
		{
			return new PriKey_Customers_Record();
		}

		protected override PriKey_Customers_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_Customers_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 244, 86, 62, 201, 41, 129, 212, 132, 52, 90, 121, 251, 143, 106, 202, 23 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "F4563EC92981D484345A79FB8F6ACA17"; }
		}
		...
		{
			get { return new DateTime(2021, 5, 19, 9, 12, 9); } // Wednesday, 19 May 2021 at 09:12:09
		}
		...
		public void SetExecSqlParams(long? CustomerID)
		{
			_inputparametervalues[0] = CustomerID;
		}

		public void ExecSql(long? CustomerID)
		{
			_inputparametervalues[0] = CustomerID;
			Transactional.ExecSql(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
		}

		public void ExecSql(Connector connector, long? CustomerID)
		{
			_inputparametervalues[0] = CustomerID;
			Transactional.ExecSql(connector, new IRecordsetBase[] { this });
		}

		public async Task ExecSqlAsync(long? CustomerID)
		{
			_inputparametervalues[0] = CustomerID;
			await Transactional.ExecSqlAsync(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
		}

		public async Task ExecSqlAsync(Connector connector, long? CustomerID)
		{
			_inputparametervalues[0] = CustomerID;
	...
	public sealed partial class PriKey_Customers_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_Customers_Record()
		{
			_cur__CustomerID = 0;
			_cur__AddressLine1 = "";
		...
		public PriKey_Customers_Record(object[] columnvalues)
		{
			...
			_cur__Picture = (byte[])columnvalues[20];
			...
			_cur__Thumbnail = (byte[])columnvalues[25];
		...
		public string CountryCode
		{
			...
			set
			{
				if (value == null) throw new ArgumentNullException("CountryCode", VenturaSqlStrings.SET_NULL_MSG);
		...
		public string CreatedOn
		{
			...
			set
			{
				if (value == null) throw new ArgumentNullException("CreatedOn", VenturaSqlStrings.SET_NULL_MSG);
		...
		public string LastModifiedOn
		{
			...
			set
			{
				if (value == null) throw new ArgumentNullException("LastModifiedOn", VenturaSqlStrings.SET_NULL_MSG);
		...
		public string Region
		{
			...
			set
			{
				if (value == null) throw new ArgumentNullException("Region", VenturaSqlStrings.SET_NULL_MSG);
		...
		void IRecordBase.ValidateBeforeSaving(int record_index_to_display)
		{
			...
			if (_mod__CustomerID == false) throw new Exception(string.Format(VenturaSqlStrings.VALUE_NOT_SET_MSG, record_index_to_display, "CustomerID"));
		}
...
namespace ProgrammingPattern.VenturaAutoCreate
{
	public partial class PriKey_Customers_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
