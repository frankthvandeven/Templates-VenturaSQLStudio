...
namespace AspNetCoreServer.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Person_Address_Recordset : ResultsetObservable<GetAll_Person_Address_Recordset, GetAll_Person_Address_Record>, IRecordsetBase
	{
		...
		public GetAll_Person_Address_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [AddressID],[AddressLine1],[AddressLine2],[City],[StateProvinceID],[PostalCode],[SpatialLocation],[rowguid],[ModifiedDate]" + CRLF +
			             @"FROM [Person].[Address]";
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Person_Address_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Person_Address_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Person_Address_Record NewRecord()
		{
			return new GetAll_Person_Address_Record();
		}

		protected override GetAll_Person_Address_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Person_Address_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 90, 4, 50, 18, 60, 211, 65, 224, 5, 2, 122, 172, 34, 60, 118, 189 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "5A0432123CD341E005027AAC223C76BD"; }
		}
	...
	public sealed partial class GetAll_Person_Address_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Person_Address_Record()
		{
			_cur__AddressID = 0;
			_cur__AddressLine1 = "";
		...
		public GetAll_Person_Address_Record(object[] columnvalues)
		{
...
namespace AspNetCoreServer.VenturaAutoCreate
{
	public partial class GetAll_Person_Address_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
