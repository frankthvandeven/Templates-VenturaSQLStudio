...
namespace AspNetCoreServer.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Person_BusinessEntityContact_Recordset : ResultsetObservable<GetAll_Person_BusinessEntityContact_Recordset, GetAll_Person_BusinessEntityContact_Record>, IRecordsetBase
	{
		...
		public GetAll_Person_BusinessEntityContact_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [BusinessEntityID],[PersonID],[ContactTypeID],[rowguid],[ModifiedDate]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Person_BusinessEntityContact_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Person_BusinessEntityContact_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Person_BusinessEntityContact_Record NewRecord()
		{
			return new GetAll_Person_BusinessEntityContact_Record();
		}

		protected override GetAll_Person_BusinessEntityContact_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Person_BusinessEntityContact_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 54, 160, 49, 72, 36, 141, 140, 132, 24, 38, 217, 210, 12, 4, 156, 76 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "36A03148248D8C841826D9D20C049C4C"; }
		}
	...
	public sealed partial class GetAll_Person_BusinessEntityContact_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Person_BusinessEntityContact_Record()
		{
		...
		public GetAll_Person_BusinessEntityContact_Record(object[] columnvalues)
		{
...
namespace AspNetCoreServer.VenturaAutoCreate
{
	public partial class GetAll_Person_BusinessEntityContact_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
