...
{
	/// <summary>
	/// The updateable table is [Person].[BusinessEntity]. Updateable table column information:
	...
	/// </summary>
	public partial class GetAll_Person_BusinessEntity_Recordset : ResultsetObservable<GetAll_Person_BusinessEntity_Recordset, GetAll_Person_BusinessEntity_Record>, IRecordsetBase
	{
		...
		/// <summary>
		/// Database Column NotUpdateable. Table [Person].[BusinessEntity]. PrimaryKey. NotReadonly. NotNull. IsIdentity. AutoIncrement.
		/// </summary>
		...
		/// <summary>
		/// Database Column Updateable. Table [Person].[BusinessEntity]. NotReadonly. NotNull.
		/// </summary>
		public Guid rowguid
		{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Person_BusinessEntity_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Person_BusinessEntity_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Person_BusinessEntity_Record NewRecord()
		{
			return new GetAll_Person_BusinessEntity_Record();
		}

		protected override GetAll_Person_BusinessEntity_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Person_BusinessEntity_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 196, 218, 145, 75, 44, 174, 129, 36, 117, 239, 248, 187, 147, 42, 17, 242 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "C4DA914B2CAE812475EFF8BB932A11F2"; }
		}
	...
	public sealed partial class GetAll_Person_BusinessEntity_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Person_BusinessEntity_Record()
		{
		...
		public GetAll_Person_BusinessEntity_Record(object[] columnvalues)
		{
			_cur__BusinessEntityID = (int)columnvalues[0];
			_cur__rowguid = (Guid)columnvalues[1];
		...
		void IRecordBase.WriteChangesToTrackArray(TrackArray track_array)
		{
			...
			{
				track_array.AppendDataValue(1, _cur__rowguid);
				track_array.AppendDataValue(2, _cur__ModifiedDate);
			}
			else if (_recordstatus == DataRecordStatus.Existing)
			{
				if (_mod__rowguid) track_array.AppendDataValue(1, _cur__rowguid);
		...
		{
			_cur__BusinessEntityID = (int)value;
			OnPropertyChanged("BusinessEntityID");
			OnAfterPropertyChanged("BusinessEntityID");
		}
...
namespace AspNetCoreServer.VenturaAutoCreate
{
	public partial class GetAll_Person_BusinessEntity_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
