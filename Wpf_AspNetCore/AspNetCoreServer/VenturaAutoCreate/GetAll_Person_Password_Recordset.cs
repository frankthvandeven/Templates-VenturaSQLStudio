...
namespace AspNetCoreServer.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Person_Password_Recordset : ResultsetObservable<GetAll_Person_Password_Recordset, GetAll_Person_Password_Record>, IRecordsetBase
	{
		...
		public GetAll_Person_Password_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [BusinessEntityID],[PasswordHash],[PasswordSalt],[rowguid],[ModifiedDate]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Person_Password_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Person_Password_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Person_Password_Record NewRecord()
		{
			return new GetAll_Person_Password_Record();
		}

		protected override GetAll_Person_Password_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Person_Password_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 159, 165, 242, 230, 92, 96, 147, 212, 66, 108, 157, 191, 72, 55, 200, 51 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "9FA5F2E65C6093D4426C9DBF4837C833"; }
		}
	...
	public sealed partial class GetAll_Person_Password_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Person_Password_Record()
		{
		...
		public GetAll_Person_Password_Record(object[] columnvalues)
		{
...
namespace AspNetCoreServer.VenturaAutoCreate
{
	public partial class GetAll_Person_Password_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
