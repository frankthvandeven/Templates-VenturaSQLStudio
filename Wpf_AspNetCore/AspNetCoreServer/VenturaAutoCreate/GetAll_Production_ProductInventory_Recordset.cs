...
namespace AspNetCoreServer.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Production_ProductInventory_Recordset : ResultsetObservable<GetAll_Production_ProductInventory_Recordset, GetAll_Production_ProductInventory_Record>, IRecordsetBase
	{
		...
		public GetAll_Production_ProductInventory_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [ProductID],[LocationID],[Shelf],[Bin],[Quantity],[rowguid],[ModifiedDate]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Production_ProductInventory_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Production_ProductInventory_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Production_ProductInventory_Record NewRecord()
		{
			return new GetAll_Production_ProductInventory_Record();
		}

		protected override GetAll_Production_ProductInventory_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Production_ProductInventory_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 160, 175, 25, 210, 252, 240, 172, 172, 253, 37, 242, 96, 35, 144, 243, 72 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "A0AF19D2FCF0ACACFD25F2602390F348"; }
		}
	...
	public sealed partial class GetAll_Production_ProductInventory_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Production_ProductInventory_Record()
		{
			_cur__ProductID = 0;
			_cur__LocationID = 0;
			_cur__Shelf = "";
		...
		public GetAll_Production_ProductInventory_Record(object[] columnvalues)
		{
...
namespace AspNetCoreServer.VenturaAutoCreate
{
	public partial class GetAll_Production_ProductInventory_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
