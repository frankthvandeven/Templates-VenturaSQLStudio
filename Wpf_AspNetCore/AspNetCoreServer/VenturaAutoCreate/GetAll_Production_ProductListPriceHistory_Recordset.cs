...
namespace AspNetCoreServer.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Production_ProductListPriceHistory_Recordset : ResultsetObservable<GetAll_Production_ProductListPriceHistory_Recordset, GetAll_Production_ProductListPriceHistory_Record>, IRecordsetBase
	{
		...
		public GetAll_Production_ProductListPriceHistory_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [ProductID],[StartDate],[EndDate],[ListPrice],[ModifiedDate]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Production_ProductListPriceHistory_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Production_ProductListPriceHistory_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Production_ProductListPriceHistory_Record NewRecord()
		{
			return new GetAll_Production_ProductListPriceHistory_Record();
		}

		protected override GetAll_Production_ProductListPriceHistory_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Production_ProductListPriceHistory_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 15, 8, 98, 48, 131, 245, 63, 182, 155, 233, 160, 62, 123, 72, 248, 88 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "0F08623083F53FB69BE9A03E7B48F858"; }
		}
	...
	public sealed partial class GetAll_Production_ProductListPriceHistory_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Production_ProductListPriceHistory_Record()
		{
			_cur__ProductID = 0;
		...
		public GetAll_Production_ProductListPriceHistory_Record(object[] columnvalues)
		{
...
namespace AspNetCoreServer.VenturaAutoCreate
{
	public partial class GetAll_Production_ProductListPriceHistory_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
