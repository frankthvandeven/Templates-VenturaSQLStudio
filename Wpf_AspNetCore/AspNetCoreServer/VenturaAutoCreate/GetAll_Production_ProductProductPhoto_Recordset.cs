...
namespace AspNetCoreServer.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Production_ProductProductPhoto_Recordset : ResultsetObservable<GetAll_Production_ProductProductPhoto_Recordset, GetAll_Production_ProductProductPhoto_Record>, IRecordsetBase
	{
		...
		public GetAll_Production_ProductProductPhoto_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [ProductID],[ProductPhotoID],[Primary],[ModifiedDate]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Production_ProductProductPhoto_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Production_ProductProductPhoto_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Production_ProductProductPhoto_Record NewRecord()
		{
			return new GetAll_Production_ProductProductPhoto_Record();
		}

		protected override GetAll_Production_ProductProductPhoto_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Production_ProductProductPhoto_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 31, 240, 25, 0, 232, 43, 100, 164, 136, 149, 239, 169, 95, 39, 199, 209 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "1FF01900E82B64A48895EFA95F27C7D1"; }
		}
	...
	public sealed partial class GetAll_Production_ProductProductPhoto_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Production_ProductProductPhoto_Record()
		{
			_cur__ProductID = 0;
		...
		public GetAll_Production_ProductProductPhoto_Record(object[] columnvalues)
		{
...
namespace AspNetCoreServer.VenturaAutoCreate
{
	public partial class GetAll_Production_ProductProductPhoto_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
