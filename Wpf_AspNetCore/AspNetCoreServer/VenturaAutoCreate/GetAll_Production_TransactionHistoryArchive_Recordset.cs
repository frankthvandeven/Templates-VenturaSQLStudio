...
namespace AspNetCoreServer.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Production_TransactionHistoryArchive_Recordset : ResultsetObservable<GetAll_Production_TransactionHistoryArchive_Recordset, GetAll_Production_TransactionHistoryArchive_Record>, IRecordsetBase
	{
		...
		public GetAll_Production_TransactionHistoryArchive_Recordset()
		{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Production_TransactionHistoryArchive_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Production_TransactionHistoryArchive_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Production_TransactionHistoryArchive_Record NewRecord()
		{
			return new GetAll_Production_TransactionHistoryArchive_Record();
		}

		protected override GetAll_Production_TransactionHistoryArchive_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Production_TransactionHistoryArchive_Record(columnvalues);
	...
	public sealed partial class GetAll_Production_TransactionHistoryArchive_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Production_TransactionHistoryArchive_Record()
		{
		...
		public GetAll_Production_TransactionHistoryArchive_Record(object[] columnvalues)
		{
...
namespace AspNetCoreServer.VenturaAutoCreate
{
	public partial class GetAll_Production_TransactionHistoryArchive_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
