...
namespace AspNetCoreServer.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Production_WorkOrderRouting_Recordset : ResultsetObservable<GetAll_Production_WorkOrderRouting_Recordset, GetAll_Production_WorkOrderRouting_Record>, IRecordsetBase
	{
		...
		public GetAll_Production_WorkOrderRouting_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [WorkOrderID],[ProductID],[OperationSequence],[LocationID],[ScheduledStartDate],[ScheduledEndDate],[ActualStartDate],[ActualEndDate]," + CRLF +
			             @"[ActualResourceHrs],[PlannedCost],[ActualCost],[ModifiedDate]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Production_WorkOrderRouting_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Production_WorkOrderRouting_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Production_WorkOrderRouting_Record NewRecord()
		{
			return new GetAll_Production_WorkOrderRouting_Record();
		}

		protected override GetAll_Production_WorkOrderRouting_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Production_WorkOrderRouting_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 69, 99, 13, 206, 138, 222, 78, 179, 170, 148, 94, 10, 225, 77, 236, 17 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "45630DCE8ADE4EB3AA945E0AE14DEC11"; }
		}
	...
	public sealed partial class GetAll_Production_WorkOrderRouting_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Production_WorkOrderRouting_Record()
		{
			_cur__WorkOrderID = 0;
			_cur__ProductID = 0;
		...
		public GetAll_Production_WorkOrderRouting_Record(object[] columnvalues)
		{
...
namespace AspNetCoreServer.VenturaAutoCreate
{
	public partial class GetAll_Production_WorkOrderRouting_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
