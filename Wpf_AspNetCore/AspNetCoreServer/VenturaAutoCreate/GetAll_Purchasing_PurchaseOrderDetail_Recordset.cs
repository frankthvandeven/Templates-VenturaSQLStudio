...
namespace AspNetCoreServer.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Purchasing_PurchaseOrderDetail_Recordset : ResultsetObservable<GetAll_Purchasing_PurchaseOrderDetail_Recordset, GetAll_Purchasing_PurchaseOrderDetail_Record>, IRecordsetBase
	{
		...
		public GetAll_Purchasing_PurchaseOrderDetail_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [PurchaseOrderID],[PurchaseOrderDetailID],[DueDate],[OrderQty],[ProductID],[UnitPrice],[LineTotal],[ReceivedQty],[RejectedQty],[StockedQty]," + CRLF +
			             @"[ModifiedDate]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Purchasing_PurchaseOrderDetail_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Purchasing_PurchaseOrderDetail_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Purchasing_PurchaseOrderDetail_Record NewRecord()
		{
			return new GetAll_Purchasing_PurchaseOrderDetail_Record();
		}

		protected override GetAll_Purchasing_PurchaseOrderDetail_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Purchasing_PurchaseOrderDetail_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 175, 165, 182, 162, 140, 15, 191, 74, 249, 181, 69, 48, 235, 142, 171, 71 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "AFA5B6A28C0FBF4AF9B54530EB8EAB47"; }
		}
	...
	public sealed partial class GetAll_Purchasing_PurchaseOrderDetail_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Purchasing_PurchaseOrderDetail_Record()
		{
		...
		public GetAll_Purchasing_PurchaseOrderDetail_Record(object[] columnvalues)
		{
...
namespace AspNetCoreServer.VenturaAutoCreate
{
	public partial class GetAll_Purchasing_PurchaseOrderDetail_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
