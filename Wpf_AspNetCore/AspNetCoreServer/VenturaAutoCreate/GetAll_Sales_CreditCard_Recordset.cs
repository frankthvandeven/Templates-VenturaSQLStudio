...
namespace AspNetCoreServer.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Sales_CreditCard_Recordset : ResultsetObservable<GetAll_Sales_CreditCard_Recordset, GetAll_Sales_CreditCard_Record>, IRecordsetBase
	{
		...
		public GetAll_Sales_CreditCard_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [CreditCardID],[CardType],[CardNumber],[ExpMonth],[ExpYear],[ModifiedDate]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Sales_CreditCard_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Sales_CreditCard_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Sales_CreditCard_Record NewRecord()
		{
			return new GetAll_Sales_CreditCard_Record();
		}

		protected override GetAll_Sales_CreditCard_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Sales_CreditCard_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 173, 134, 134, 96, 74, 171, 102, 73, 49, 91, 132, 199, 254, 111, 198, 233 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "AD8686604AAB6649315B84C7FE6FC6E9"; }
		}
	...
	public sealed partial class GetAll_Sales_CreditCard_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Sales_CreditCard_Record()
		{
		...
		public GetAll_Sales_CreditCard_Record(object[] columnvalues)
		{
...
namespace AspNetCoreServer.VenturaAutoCreate
{
	public partial class GetAll_Sales_CreditCard_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
