...
namespace AspNetCoreServer.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Sales_SalesPersonQuotaHistory_Recordset : ResultsetObservable<GetAll_Sales_SalesPersonQuotaHistory_Recordset, GetAll_Sales_SalesPersonQuotaHistory_Record>, IRecordsetBase
	{
		...
		public GetAll_Sales_SalesPersonQuotaHistory_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [BusinessEntityID],[QuotaDate],[SalesQuota],[rowguid],[ModifiedDate]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Sales_SalesPersonQuotaHistory_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Sales_SalesPersonQuotaHistory_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Sales_SalesPersonQuotaHistory_Record NewRecord()
		{
			return new GetAll_Sales_SalesPersonQuotaHistory_Record();
		}

		protected override GetAll_Sales_SalesPersonQuotaHistory_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Sales_SalesPersonQuotaHistory_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 184, 95, 38, 8, 236, 114, 236, 155, 185, 201, 34, 11, 159, 100, 49, 55 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "B85F2608EC72EC9BB9C9220B9F643137"; }
		}
	...
	public sealed partial class GetAll_Sales_SalesPersonQuotaHistory_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Sales_SalesPersonQuotaHistory_Record()
		{
		...
		public GetAll_Sales_SalesPersonQuotaHistory_Record(object[] columnvalues)
		{
...
namespace AspNetCoreServer.VenturaAutoCreate
{
	public partial class GetAll_Sales_SalesPersonQuotaHistory_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
