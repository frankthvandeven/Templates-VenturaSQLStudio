...
namespace AspNetCoreServer.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Sales_SalesTerritory_Recordset : ResultsetObservable<GetAll_Sales_SalesTerritory_Recordset, GetAll_Sales_SalesTerritory_Record>, IRecordsetBase
	{
		...
		public GetAll_Sales_SalesTerritory_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [TerritoryID],[Name],[CountryRegionCode],[Group],[SalesYTD],[SalesLastYear],[CostYTD],[CostLastYear],[rowguid],[ModifiedDate]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Sales_SalesTerritory_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Sales_SalesTerritory_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Sales_SalesTerritory_Record NewRecord()
		{
			return new GetAll_Sales_SalesTerritory_Record();
		}

		protected override GetAll_Sales_SalesTerritory_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Sales_SalesTerritory_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 27, 32, 89, 111, 7, 78, 236, 21, 252, 87, 188, 240, 192, 33, 32, 166 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "1B20596F074EEC15FC57BCF0C02120A6"; }
		}
	...
	public sealed partial class GetAll_Sales_SalesTerritory_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Sales_SalesTerritory_Record()
		{
			_cur__TerritoryID = 0;
			_cur__Name = "";
		...
		public GetAll_Sales_SalesTerritory_Record(object[] columnvalues)
		{
...
namespace AspNetCoreServer.VenturaAutoCreate
{
	public partial class GetAll_Sales_SalesTerritory_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
