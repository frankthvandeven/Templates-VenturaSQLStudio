...
namespace AspNetCoreServer.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Sales_SpecialOffer_Recordset : ResultsetObservable<GetAll_Sales_SpecialOffer_Recordset, GetAll_Sales_SpecialOffer_Record>, IRecordsetBase
	{
		...
		public GetAll_Sales_SpecialOffer_Recordset()
		{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Sales_SpecialOffer_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Sales_SpecialOffer_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Sales_SpecialOffer_Record NewRecord()
		{
			return new GetAll_Sales_SpecialOffer_Record();
		}

		protected override GetAll_Sales_SpecialOffer_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Sales_SpecialOffer_Record(columnvalues);
	...
	public sealed partial class GetAll_Sales_SpecialOffer_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Sales_SpecialOffer_Record()
		{
		...
		public GetAll_Sales_SpecialOffer_Record(object[] columnvalues)
		{
...
namespace AspNetCoreServer.VenturaAutoCreate
{
	public partial class GetAll_Sales_SpecialOffer_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
