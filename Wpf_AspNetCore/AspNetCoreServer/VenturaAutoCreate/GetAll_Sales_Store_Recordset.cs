...
namespace AspNetCoreServer.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Sales_Store_Recordset : ResultsetObservable<GetAll_Sales_Store_Recordset, GetAll_Sales_Store_Record>, IRecordsetBase
	{
		...
		public GetAll_Sales_Store_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [BusinessEntityID],[Name],[SalesPersonID],[Demographics],[rowguid],[ModifiedDate]" + CRLF +
			             @"FROM [Sales].[Store]";
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Sales_Store_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Sales_Store_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Sales_Store_Record NewRecord()
		{
			return new GetAll_Sales_Store_Record();
		}

		protected override GetAll_Sales_Store_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Sales_Store_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 84, 208, 74, 98, 150, 168, 6, 51, 158, 155, 52, 52, 118, 162, 24, 36 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "54D04A6296A806339E9B343476A21824"; }
		}
	...
	public sealed partial class GetAll_Sales_Store_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Sales_Store_Record()
		{
		...
		public GetAll_Sales_Store_Record(object[] columnvalues)
		{
...
namespace AspNetCoreServer.VenturaAutoCreate
{
	public partial class GetAll_Sales_Store_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
