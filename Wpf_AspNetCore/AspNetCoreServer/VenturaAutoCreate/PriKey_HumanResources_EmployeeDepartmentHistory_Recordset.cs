...
namespace AspNetCoreServer.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class PriKey_HumanResources_EmployeeDepartmentHistory_Recordset : ResultsetObservable<PriKey_HumanResources_EmployeeDepartmentHistory_Recordset, PriKey_HumanResources_EmployeeDepartmentHistory_Record>, IRecordsetBase
	{
		...
		public PriKey_HumanResources_EmployeeDepartmentHistory_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT [BusinessEntityID],[DepartmentID],[ShiftID],[StartDate],[EndDate],[ModifiedDate]" + CRLF +
			             @"FROM [HumanResources].[EmployeeDepartmentHistory]" + CRLF +
			             @"WHERE [BusinessEntityID] = @BusinessEntityID" + CRLF +
			             @"AND [DepartmentID] = @DepartmentID" + CRLF +
			             @"AND [ShiftID] = @ShiftID" + CRLF +
			             @"AND [StartDate] = @StartDate";

			_inputparametervalues = new object[4];
			...
			param_array.AddParameterColumn("@ShiftID", typeof(byte), true, false, DbType.Byte, null, null, null);
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_HumanResources_EmployeeDepartmentHistory_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_HumanResources_EmployeeDepartmentHistory_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_HumanResources_EmployeeDepartmentHistory_Record NewRecord()
		{
			return new PriKey_HumanResources_EmployeeDepartmentHistory_Record();
		}

		protected override PriKey_HumanResources_EmployeeDepartmentHistory_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_HumanResources_EmployeeDepartmentHistory_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 87, 97, 179, 127, 233, 97, 171, 99, 222, 205, 20, 31, 210, 230, 222, 18 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "5761B37FE961AB63DECD141FD2E6DE12"; }
		}
		...
		public void SetExecSqlParams(int? BusinessEntityID, short? DepartmentID, byte? ShiftID, DateTime? StartDate)
		{
			_inputparametervalues[0] = BusinessEntityID;
			_inputparametervalues[1] = DepartmentID;
			_inputparametervalues[2] = ShiftID;
			_inputparametervalues[3] = StartDate;
		}

		public void ExecSql(int? BusinessEntityID, short? DepartmentID, byte? ShiftID, DateTime? StartDate)
		{
			_inputparametervalues[0] = BusinessEntityID;
			_inputparametervalues[1] = DepartmentID;
			_inputparametervalues[2] = ShiftID;
		...
		public void ExecSql(Connector connector, int? BusinessEntityID, short? DepartmentID, byte? ShiftID, DateTime? StartDate)
		{
			_inputparametervalues[0] = BusinessEntityID;
			_inputparametervalues[1] = DepartmentID;
			_inputparametervalues[2] = ShiftID;
		...
		public async Task ExecSqlAsync(int? BusinessEntityID, short? DepartmentID, byte? ShiftID, DateTime? StartDate)
		{
			_inputparametervalues[0] = BusinessEntityID;
			_inputparametervalues[1] = DepartmentID;
			_inputparametervalues[2] = ShiftID;
		...
		public async Task ExecSqlAsync(Connector connector, int? BusinessEntityID, short? DepartmentID, byte? ShiftID, DateTime? StartDate)
		{
			_inputparametervalues[0] = BusinessEntityID;
			_inputparametervalues[1] = DepartmentID;
			_inputparametervalues[2] = ShiftID;
		...
		public class InputParamHolder
		{
			...
			public byte? ShiftID
			{
				get { return (byte?)_values[2]; }
				set { _values[2] = value; }
			}

			public DateTime? StartDate
			{
				get { return (DateTime?)_values[3]; }
				set { _values[3] = value; }
			}
	...
	public sealed partial class PriKey_HumanResources_EmployeeDepartmentHistory_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_HumanResources_EmployeeDepartmentHistory_Record()
		{
		...
		public PriKey_HumanResources_EmployeeDepartmentHistory_Record(object[] columnvalues)
		{
...
namespace AspNetCoreServer.VenturaAutoCreate
{
	public partial class PriKey_HumanResources_EmployeeDepartmentHistory_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
