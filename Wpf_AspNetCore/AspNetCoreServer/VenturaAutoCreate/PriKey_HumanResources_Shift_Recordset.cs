...
namespace AspNetCoreServer.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class PriKey_HumanResources_Shift_Recordset : ResultsetObservable<PriKey_HumanResources_Shift_Recordset, PriKey_HumanResources_Shift_Record>, IRecordsetBase
	{
		...
		public PriKey_HumanResources_Shift_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT [ShiftID],[Name],[StartTime],[EndTime],[ModifiedDate]" + CRLF +
			             @"FROM [HumanResources].[Shift]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_HumanResources_Shift_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_HumanResources_Shift_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_HumanResources_Shift_Record NewRecord()
		{
			return new PriKey_HumanResources_Shift_Record();
		}

		protected override PriKey_HumanResources_Shift_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_HumanResources_Shift_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 85, 99, 176, 169, 254, 73, 215, 224, 23, 102, 81, 11, 54, 165, 24, 247 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "5563B0A9FE49D7E01766510B36A518F7"; }
		}
		...
		public void SetExecSqlParams(byte? ShiftID)
		{
			_inputparametervalues[0] = ShiftID;
		}

		public void ExecSql(byte? ShiftID)
		{
			_inputparametervalues[0] = ShiftID;
			Transactional.ExecSql(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
		}

		public void ExecSql(Connector connector, byte? ShiftID)
		{
			_inputparametervalues[0] = ShiftID;
			Transactional.ExecSql(connector, new IRecordsetBase[] { this });
		}

		public async Task ExecSqlAsync(byte? ShiftID)
		{
			_inputparametervalues[0] = ShiftID;
			await Transactional.ExecSqlAsync(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
		}

		public async Task ExecSqlAsync(Connector connector, byte? ShiftID)
		{
			_inputparametervalues[0] = ShiftID;
	...
	public sealed partial class PriKey_HumanResources_Shift_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_HumanResources_Shift_Record()
		{
			_cur__ShiftID = 0;
			_cur__Name = "";
		...
		public PriKey_HumanResources_Shift_Record(object[] columnvalues)
		{
...
namespace AspNetCoreServer.VenturaAutoCreate
{
	public partial class PriKey_HumanResources_Shift_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
