...
namespace AspNetCoreServer.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class PriKey_Person_EmailAddress_Recordset : ResultsetObservable<PriKey_Person_EmailAddress_Recordset, PriKey_Person_EmailAddress_Record>, IRecordsetBase
	{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_Person_EmailAddress_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_Person_EmailAddress_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_Person_EmailAddress_Record NewRecord()
		{
			return new PriKey_Person_EmailAddress_Record();
		}

		protected override PriKey_Person_EmailAddress_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_Person_EmailAddress_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 107, 169, 136, 108, 62, 139, 116, 193, 144, 208, 132, 9, 163, 8, 43, 46 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "6BA9886C3E8B74C190D08409A3082B2E"; }
		}
		...
		public void SetExecSqlParams(int? BusinessEntityID, int? EmailAddressID)
		{
			_inputparametervalues[0] = BusinessEntityID;
			_inputparametervalues[1] = EmailAddressID;
		}

		public void ExecSql(int? BusinessEntityID, int? EmailAddressID)
		{
			_inputparametervalues[0] = BusinessEntityID;
			_inputparametervalues[1] = EmailAddressID;
		...
		public void ExecSql(Connector connector, int? BusinessEntityID, int? EmailAddressID)
		{
			_inputparametervalues[0] = BusinessEntityID;
			_inputparametervalues[1] = EmailAddressID;
		...
		public async Task ExecSqlAsync(int? BusinessEntityID, int? EmailAddressID)
		{
			_inputparametervalues[0] = BusinessEntityID;
			_inputparametervalues[1] = EmailAddressID;
		...
		public async Task ExecSqlAsync(Connector connector, int? BusinessEntityID, int? EmailAddressID)
		{
			_inputparametervalues[0] = BusinessEntityID;
			_inputparametervalues[1] = EmailAddressID;
	...
	public sealed partial class PriKey_Person_EmailAddress_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_Person_EmailAddress_Record()
		{
		...
		public PriKey_Person_EmailAddress_Record(object[] columnvalues)
		{
...
namespace AspNetCoreServer.VenturaAutoCreate
{
	public partial class PriKey_Person_EmailAddress_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
