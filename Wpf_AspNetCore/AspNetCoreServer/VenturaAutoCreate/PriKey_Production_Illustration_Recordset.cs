...
namespace AspNetCoreServer.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class PriKey_Production_Illustration_Recordset : ResultsetObservable<PriKey_Production_Illustration_Recordset, PriKey_Production_Illustration_Record>, IRecordsetBase
	{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_Production_Illustration_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_Production_Illustration_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_Production_Illustration_Record NewRecord()
		{
			return new PriKey_Production_Illustration_Record();
		}

		protected override PriKey_Production_Illustration_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_Production_Illustration_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 149, 202, 23, 233, 221, 12, 253, 11, 254, 203, 17, 105, 64, 124, 194, 86 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "95CA17E9DD0CFD0BFECB1169407CC256"; }
		}
		...
		public void SetExecSqlParams(int? IllustrationID)
		{
			_inputparametervalues[0] = IllustrationID;
		}

		public void ExecSql(int? IllustrationID)
		{
			_inputparametervalues[0] = IllustrationID;
			Transactional.ExecSql(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
		}

		public void ExecSql(Connector connector, int? IllustrationID)
		{
			_inputparametervalues[0] = IllustrationID;
			Transactional.ExecSql(connector, new IRecordsetBase[] { this });
		}

		public async Task ExecSqlAsync(int? IllustrationID)
		{
			_inputparametervalues[0] = IllustrationID;
			await Transactional.ExecSqlAsync(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
		}

		public async Task ExecSqlAsync(Connector connector, int? IllustrationID)
		{
			_inputparametervalues[0] = IllustrationID;
	...
	public sealed partial class PriKey_Production_Illustration_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_Production_Illustration_Record()
		{
		...
		public PriKey_Production_Illustration_Record(object[] columnvalues)
		{
...
namespace AspNetCoreServer.VenturaAutoCreate
{
	public partial class PriKey_Production_Illustration_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
