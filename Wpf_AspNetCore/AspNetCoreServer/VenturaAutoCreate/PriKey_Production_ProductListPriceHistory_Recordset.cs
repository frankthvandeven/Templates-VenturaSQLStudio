...
{
	/// <summary>
	/// The updateable table is [Production].[ProductListPriceHistory]. Updateable table column information:
	...
	/// • Non-primary key columns present in the resultset: EndDate, ListPrice and ModifiedDate.
	/// Recordset item automatically created by VenturaSQL Studio.
	/// </summary>
	public partial class PriKey_Production_ProductListPriceHistory_Recordset : ResultsetObservable<PriKey_Production_ProductListPriceHistory_Recordset, PriKey_Production_ProductListPriceHistory_Record>, IRecordsetBase
	{
		...
		public PriKey_Production_ProductListPriceHistory_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT [ProductID],[StartDate],[EndDate],[ListPrice],[ModifiedDate]" + CRLF +
			             @"FROM [Production].[ProductListPriceHistory]" + CRLF +
			...
			schema_array.Add(new VenturaSqlColumn("ProductID", typeof(int), false)
			{
				...
				BaseTableName = "ProductListPriceHistory",
			...
			((IResultsetBase)this).UpdateableTablename = "[Production].[ProductListPriceHistory]";
		}

		/// <summary>
		/// Database Column Updateable. Table [Production].[ProductListPriceHistory]. PrimaryKey. NotReadonly. NotNull.
		/// </summary>
		...
		/// <summary>
		/// Database Column Updateable. Table [Production].[ProductListPriceHistory]. NotReadonly. AllowNull.
		/// </summary>
		...
		/// <summary>
		/// Database Column Updateable. Table [Production].[ProductListPriceHistory]. NotReadonly. NotNull.
		/// </summary>
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_Production_ProductListPriceHistory_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_Production_ProductListPriceHistory_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_Production_ProductListPriceHistory_Record NewRecord()
		{
			return new PriKey_Production_ProductListPriceHistory_Record();
		}

		protected override PriKey_Production_ProductListPriceHistory_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_Production_ProductListPriceHistory_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 246, 67, 204, 70, 133, 171, 231, 113, 141, 90, 150, 135, 243, 141, 135, 120 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "F643CC4685ABE7718D5A9687F38D8778"; }
		}
		...
		public void SetExecSqlParams(int? ProductID, DateTime? StartDate)
		{
			_inputparametervalues[0] = ProductID;
			_inputparametervalues[1] = StartDate;
		}

		public void ExecSql(int? ProductID, DateTime? StartDate)
		{
			_inputparametervalues[0] = ProductID;
			_inputparametervalues[1] = StartDate;
		...
		public void ExecSql(Connector connector, int? ProductID, DateTime? StartDate)
		{
			_inputparametervalues[0] = ProductID;
			_inputparametervalues[1] = StartDate;
		...
		public async Task ExecSqlAsync(int? ProductID, DateTime? StartDate)
		{
			_inputparametervalues[0] = ProductID;
			_inputparametervalues[1] = StartDate;
		...
		public async Task ExecSqlAsync(Connector connector, int? ProductID, DateTime? StartDate)
		{
			_inputparametervalues[0] = ProductID;
			_inputparametervalues[1] = StartDate;
	...
	public sealed partial class PriKey_Production_ProductListPriceHistory_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_Production_ProductListPriceHistory_Record()
		{
			_cur__ProductID = 0;
		...
		public PriKey_Production_ProductListPriceHistory_Record(object[] columnvalues)
		{
			_cur__ProductID = (int)columnvalues[0];
			_cur__StartDate = (DateTime)columnvalues[1];
			_cur__EndDate = (DateTime?)columnvalues[2];
			_cur__ListPrice = (decimal)columnvalues[3];
		...
		void IRecordBase.WriteChangesToTrackArray(TrackArray track_array)
		{
			if (_recordstatus == DataRecordStatus.New)
			{
				...
				track_array.AppendDataValue(3, _cur__ListPrice);
			...
			else if (_recordstatus == DataRecordStatus.Existing)
			{
				...
				if (_mod__ListPrice) track_array.AppendDataValue(3, _cur__ListPrice);
...
namespace AspNetCoreServer.VenturaAutoCreate
{
	public partial class PriKey_Production_ProductListPriceHistory_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
