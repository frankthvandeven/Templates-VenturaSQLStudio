...
namespace AspNetCoreServer.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class PriKey_Production_ProductModelProductDescriptionCulture_Recordset : ResultsetObservable<PriKey_Production_ProductModelProductDescriptionCulture_Recordset, PriKey_Production_ProductModelProductDescriptionCulture_Record>, IRecordsetBase
	{
		...
		public PriKey_Production_ProductModelProductDescriptionCulture_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT [ProductModelID],[ProductDescriptionID],[CultureID],[ModifiedDate]" + CRLF +
			             @"FROM [Production].[ProductModelProductDescriptionCulture]" + CRLF +
			             @"WHERE [ProductModelID] = @ProductModelID" + CRLF +
			             @"AND [ProductDescriptionID] = @ProductDescriptionID" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_Production_ProductModelProductDescriptionCulture_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_Production_ProductModelProductDescriptionCulture_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_Production_ProductModelProductDescriptionCulture_Record NewRecord()
		{
			return new PriKey_Production_ProductModelProductDescriptionCulture_Record();
		}

		protected override PriKey_Production_ProductModelProductDescriptionCulture_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_Production_ProductModelProductDescriptionCulture_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 227, 189, 141, 236, 173, 147, 74, 255, 172, 107, 236, 150, 172, 204, 233, 72 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "E3BD8DECAD934AFFAC6BEC96ACCCE948"; }
		}
		...
		public void SetExecSqlParams(int? ProductModelID, int? ProductDescriptionID, string CultureID)
		{
			_inputparametervalues[0] = ProductModelID;
			_inputparametervalues[1] = ProductDescriptionID;
			_inputparametervalues[2] = CultureID;
		}

		public void ExecSql(int? ProductModelID, int? ProductDescriptionID, string CultureID)
		{
			_inputparametervalues[0] = ProductModelID;
			_inputparametervalues[1] = ProductDescriptionID;
			_inputparametervalues[2] = CultureID;
		...
		public void ExecSql(Connector connector, int? ProductModelID, int? ProductDescriptionID, string CultureID)
		{
			_inputparametervalues[0] = ProductModelID;
			_inputparametervalues[1] = ProductDescriptionID;
			_inputparametervalues[2] = CultureID;
		...
		public async Task ExecSqlAsync(int? ProductModelID, int? ProductDescriptionID, string CultureID)
		{
			_inputparametervalues[0] = ProductModelID;
			_inputparametervalues[1] = ProductDescriptionID;
			_inputparametervalues[2] = CultureID;
		...
		public async Task ExecSqlAsync(Connector connector, int? ProductModelID, int? ProductDescriptionID, string CultureID)
		{
			_inputparametervalues[0] = ProductModelID;
			_inputparametervalues[1] = ProductDescriptionID;
			_inputparametervalues[2] = CultureID;
	...
	public sealed partial class PriKey_Production_ProductModelProductDescriptionCulture_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_Production_ProductModelProductDescriptionCulture_Record()
		{
		...
		public PriKey_Production_ProductModelProductDescriptionCulture_Record(object[] columnvalues)
		{
...
namespace AspNetCoreServer.VenturaAutoCreate
{
	public partial class PriKey_Production_ProductModelProductDescriptionCulture_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
