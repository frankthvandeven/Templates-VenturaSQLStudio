...
namespace AspNetCoreServer.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class PriKey_Production_ProductModel_Recordset : ResultsetObservable<PriKey_Production_ProductModel_Recordset, PriKey_Production_ProductModel_Record>, IRecordsetBase
	{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_Production_ProductModel_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_Production_ProductModel_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_Production_ProductModel_Record NewRecord()
		{
			return new PriKey_Production_ProductModel_Record();
		}

		protected override PriKey_Production_ProductModel_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_Production_ProductModel_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 78, 117, 63, 211, 76, 152, 39, 248, 68, 174, 91, 162, 102, 229, 137, 248 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "4E753FD34C9827F844AE5BA266E589F8"; }
		}
		...
		public void SetExecSqlParams(int? ProductModelID)
		{
			_inputparametervalues[0] = ProductModelID;
		}

		public void ExecSql(int? ProductModelID)
		{
			_inputparametervalues[0] = ProductModelID;
			Transactional.ExecSql(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
		}

		public void ExecSql(Connector connector, int? ProductModelID)
		{
			_inputparametervalues[0] = ProductModelID;
			Transactional.ExecSql(connector, new IRecordsetBase[] { this });
		}

		public async Task ExecSqlAsync(int? ProductModelID)
		{
			_inputparametervalues[0] = ProductModelID;
			await Transactional.ExecSqlAsync(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
		}

		public async Task ExecSqlAsync(Connector connector, int? ProductModelID)
		{
			_inputparametervalues[0] = ProductModelID;
	...
	public sealed partial class PriKey_Production_ProductModel_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_Production_ProductModel_Record()
		{
		...
		public PriKey_Production_ProductModel_Record(object[] columnvalues)
		{
...
namespace AspNetCoreServer.VenturaAutoCreate
{
	public partial class PriKey_Production_ProductModel_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
