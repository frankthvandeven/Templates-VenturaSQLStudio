...
namespace AspNetCoreServer.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class PriKey_Production_ProductSubcategory_Recordset : ResultsetObservable<PriKey_Production_ProductSubcategory_Recordset, PriKey_Production_ProductSubcategory_Record>, IRecordsetBase
	{
		...
		public PriKey_Production_ProductSubcategory_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT [ProductSubcategoryID],[ProductCategoryID],[Name],[rowguid],[ModifiedDate]" + CRLF +
			             @"FROM [Production].[ProductSubcategory]" + CRLF +
			...
			param_array.AddParameterColumn("@ProductSubcategoryID", typeof(int), true, false, DbType.Int32, null, null, null);
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_Production_ProductSubcategory_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_Production_ProductSubcategory_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_Production_ProductSubcategory_Record NewRecord()
		{
			return new PriKey_Production_ProductSubcategory_Record();
		}

		protected override PriKey_Production_ProductSubcategory_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_Production_ProductSubcategory_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 114, 201, 252, 253, 217, 137, 160, 16, 145, 174, 85, 136, 106, 189, 59, 53 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "72C9FCFDD989A01091AE55886ABD3B35"; }
		}
		...
		public void SetExecSqlParams(int? ProductSubcategoryID)
		{
	...
	public sealed partial class PriKey_Production_ProductSubcategory_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_Production_ProductSubcategory_Record()
		{
		...
		public PriKey_Production_ProductSubcategory_Record(object[] columnvalues)
		{
...
namespace AspNetCoreServer.VenturaAutoCreate
{
	public partial class PriKey_Production_ProductSubcategory_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
