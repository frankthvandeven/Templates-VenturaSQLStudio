...
namespace AspNetCoreServer.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class PriKey_Purchasing_ProductVendor_Recordset : ResultsetObservable<PriKey_Purchasing_ProductVendor_Recordset, PriKey_Purchasing_ProductVendor_Record>, IRecordsetBase
	{
		...
		public PriKey_Purchasing_ProductVendor_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT [ProductID],[BusinessEntityID],[AverageLeadTime],[StandardPrice],[LastReceiptCost],[LastReceiptDate],[MinOrderQty],[MaxOrderQty],[OnOrderQty],[UnitMeasureCode]," + CRLF +
			             @"[ModifiedDate]" + CRLF +
			             @"FROM [Purchasing].[ProductVendor]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_Purchasing_ProductVendor_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_Purchasing_ProductVendor_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_Purchasing_ProductVendor_Record NewRecord()
		{
			return new PriKey_Purchasing_ProductVendor_Record();
		}

		protected override PriKey_Purchasing_ProductVendor_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_Purchasing_ProductVendor_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 128, 174, 75, 226, 164, 44, 238, 204, 77, 234, 245, 75, 170, 85, 205, 44 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "80AE4BE2A42CEECC4DEAF54BAA55CD2C"; }
		}
		...
		public void SetExecSqlParams(int? ProductID, int? BusinessEntityID)
		{
			_inputparametervalues[0] = ProductID;
			_inputparametervalues[1] = BusinessEntityID;
		}

		public void ExecSql(int? ProductID, int? BusinessEntityID)
		{
			_inputparametervalues[0] = ProductID;
			_inputparametervalues[1] = BusinessEntityID;
		...
		public void ExecSql(Connector connector, int? ProductID, int? BusinessEntityID)
		{
			_inputparametervalues[0] = ProductID;
			_inputparametervalues[1] = BusinessEntityID;
		...
		public async Task ExecSqlAsync(int? ProductID, int? BusinessEntityID)
		{
			_inputparametervalues[0] = ProductID;
			_inputparametervalues[1] = BusinessEntityID;
		...
		public async Task ExecSqlAsync(Connector connector, int? ProductID, int? BusinessEntityID)
		{
			_inputparametervalues[0] = ProductID;
			_inputparametervalues[1] = BusinessEntityID;
	...
	public sealed partial class PriKey_Purchasing_ProductVendor_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_Purchasing_ProductVendor_Record()
		{
			_cur__ProductID = 0;
		...
		public PriKey_Purchasing_ProductVendor_Record(object[] columnvalues)
		{
...
namespace AspNetCoreServer.VenturaAutoCreate
{
	public partial class PriKey_Purchasing_ProductVendor_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
