...
namespace AspNetCoreServer.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class PriKey_Purchasing_ShipMethod_Recordset : ResultsetObservable<PriKey_Purchasing_ShipMethod_Recordset, PriKey_Purchasing_ShipMethod_Record>, IRecordsetBase
	{
		...
		public PriKey_Purchasing_ShipMethod_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT [ShipMethodID],[Name],[ShipBase],[ShipRate],[rowguid],[ModifiedDate]" + CRLF +
			             @"FROM [Purchasing].[ShipMethod]" + CRLF +
			...
			param_array.AddParameterColumn("@ShipMethodID", typeof(int), true, false, DbType.Int32, null, null, null);
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_Purchasing_ShipMethod_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_Purchasing_ShipMethod_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_Purchasing_ShipMethod_Record NewRecord()
		{
			return new PriKey_Purchasing_ShipMethod_Record();
		}

		protected override PriKey_Purchasing_ShipMethod_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_Purchasing_ShipMethod_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 71, 217, 2, 222, 230, 69, 7, 150, 170, 235, 19, 217, 25, 30, 144, 239 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "47D902DEE6450796AAEB13D9191E90EF"; }
		}
		...
		public void SetExecSqlParams(int? ShipMethodID)
		{
			_inputparametervalues[0] = ShipMethodID;
		}

		public void ExecSql(int? ShipMethodID)
		{
			_inputparametervalues[0] = ShipMethodID;
			Transactional.ExecSql(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
		}

		public void ExecSql(Connector connector, int? ShipMethodID)
		{
			_inputparametervalues[0] = ShipMethodID;
			Transactional.ExecSql(connector, new IRecordsetBase[] { this });
		}

		public async Task ExecSqlAsync(int? ShipMethodID)
		{
			_inputparametervalues[0] = ShipMethodID;
			await Transactional.ExecSqlAsync(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
		}

		public async Task ExecSqlAsync(Connector connector, int? ShipMethodID)
		{
			_inputparametervalues[0] = ShipMethodID;
	...
	public sealed partial class PriKey_Purchasing_ShipMethod_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_Purchasing_ShipMethod_Record()
		{
		...
		public PriKey_Purchasing_ShipMethod_Record(object[] columnvalues)
		{
...
namespace AspNetCoreServer.VenturaAutoCreate
{
	public partial class PriKey_Purchasing_ShipMethod_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
