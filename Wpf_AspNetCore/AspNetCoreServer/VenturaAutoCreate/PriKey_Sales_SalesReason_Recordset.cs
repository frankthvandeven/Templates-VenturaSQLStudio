...
namespace AspNetCoreServer.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class PriKey_Sales_SalesReason_Recordset : ResultsetObservable<PriKey_Sales_SalesReason_Recordset, PriKey_Sales_SalesReason_Record>, IRecordsetBase
	{
		...
		public PriKey_Sales_SalesReason_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT [SalesReasonID],[Name],[ReasonType],[ModifiedDate]" + CRLF +
			             @"FROM [Sales].[SalesReason]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_Sales_SalesReason_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_Sales_SalesReason_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_Sales_SalesReason_Record NewRecord()
		{
			return new PriKey_Sales_SalesReason_Record();
		}

		protected override PriKey_Sales_SalesReason_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_Sales_SalesReason_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 155, 50, 82, 138, 93, 62, 42, 139, 112, 18, 78, 43, 145, 73, 165, 32 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "9B32528A5D3E2A8B70124E2B9149A520"; }
		}
		...
		public void SetExecSqlParams(int? SalesReasonID)
		{
			_inputparametervalues[0] = SalesReasonID;
		}

		public void ExecSql(int? SalesReasonID)
		{
			_inputparametervalues[0] = SalesReasonID;
			Transactional.ExecSql(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
		}

		public void ExecSql(Connector connector, int? SalesReasonID)
		{
			_inputparametervalues[0] = SalesReasonID;
			Transactional.ExecSql(connector, new IRecordsetBase[] { this });
		}

		public async Task ExecSqlAsync(int? SalesReasonID)
		{
			_inputparametervalues[0] = SalesReasonID;
			await Transactional.ExecSqlAsync(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
		}

		public async Task ExecSqlAsync(Connector connector, int? SalesReasonID)
		{
			_inputparametervalues[0] = SalesReasonID;
	...
	public sealed partial class PriKey_Sales_SalesReason_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_Sales_SalesReason_Record()
		{
		...
		public PriKey_Sales_SalesReason_Record(object[] columnvalues)
		{
...
namespace AspNetCoreServer.VenturaAutoCreate
{
	public partial class PriKey_Sales_SalesReason_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
