...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_HumanResources_EmployeePayHistory_Recordset : ResultsetObservable<GetAll_HumanResources_EmployeePayHistory_Recordset, GetAll_HumanResources_EmployeePayHistory_Record>, IRecordsetBase
	{
		...
		public GetAll_HumanResources_EmployeePayHistory_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [BusinessEntityID],[RateChangeDate],[Rate],[PayFrequency],[ModifiedDate]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_HumanResources_EmployeePayHistory_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_HumanResources_EmployeePayHistory_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_HumanResources_EmployeePayHistory_Record NewRecord()
		{
			return new GetAll_HumanResources_EmployeePayHistory_Record();
		}

		protected override GetAll_HumanResources_EmployeePayHistory_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_HumanResources_EmployeePayHistory_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 35, 19, 171, 176, 0, 176, 147, 240, 41, 18, 195, 245, 150, 29, 235, 61 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "2313ABB000B093F02912C3F5961DEB3D"; }
		}
	...
	public sealed partial class GetAll_HumanResources_EmployeePayHistory_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_HumanResources_EmployeePayHistory_Record()
		{
		...
		public GetAll_HumanResources_EmployeePayHistory_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class GetAll_HumanResources_EmployeePayHistory_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
