...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_HumanResources_Employee_Recordset : ResultsetObservable<GetAll_HumanResources_Employee_Recordset, GetAll_HumanResources_Employee_Record>, IRecordsetBase
	{
		...
		public GetAll_HumanResources_Employee_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [BusinessEntityID],[NationalIDNumber],[LoginID],[OrganizationNode],[OrganizationLevel],[JobTitle],[BirthDate],[MaritalStatus],[Gender]," + CRLF +
			             @"[HireDate],[SalariedFlag],[VacationHours],[SickLeaveHours],[CurrentFlag],[rowguid],[ModifiedDate]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_HumanResources_Employee_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_HumanResources_Employee_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_HumanResources_Employee_Record NewRecord()
		{
			return new GetAll_HumanResources_Employee_Record();
		}

		protected override GetAll_HumanResources_Employee_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_HumanResources_Employee_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 87, 129, 50, 112, 193, 46, 83, 143, 212, 131, 91, 55, 142, 132, 39, 207 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "57813270C12E538FD4835B378E8427CF"; }
		}
	...
	public sealed partial class GetAll_HumanResources_Employee_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_HumanResources_Employee_Record()
		{
		...
		public GetAll_HumanResources_Employee_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class GetAll_HumanResources_Employee_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
