...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_HumanResources_JobCandidate_Recordset : ResultsetObservable<GetAll_HumanResources_JobCandidate_Recordset, GetAll_HumanResources_JobCandidate_Record>, IRecordsetBase
	{
		...
		public GetAll_HumanResources_JobCandidate_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [JobCandidateID],[BusinessEntityID],[Resume],[ModifiedDate]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_HumanResources_JobCandidate_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_HumanResources_JobCandidate_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_HumanResources_JobCandidate_Record NewRecord()
		{
			return new GetAll_HumanResources_JobCandidate_Record();
		}

		protected override GetAll_HumanResources_JobCandidate_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_HumanResources_JobCandidate_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 172, 2, 155, 99, 186, 0, 227, 5, 55, 207, 35, 169, 112, 58, 195, 237 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "AC029B63BA00E30537CF23A9703AC3ED"; }
		}
	...
	public sealed partial class GetAll_HumanResources_JobCandidate_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_HumanResources_JobCandidate_Record()
		{
		...
		public GetAll_HumanResources_JobCandidate_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class GetAll_HumanResources_JobCandidate_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
