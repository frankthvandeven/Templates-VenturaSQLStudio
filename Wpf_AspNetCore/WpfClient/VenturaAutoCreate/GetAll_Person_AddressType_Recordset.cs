...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Person_AddressType_Recordset : ResultsetObservable<GetAll_Person_AddressType_Recordset, GetAll_Person_AddressType_Record>, IRecordsetBase
	{
		...
		public GetAll_Person_AddressType_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [AddressTypeID],[Name],[rowguid],[ModifiedDate]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Person_AddressType_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Person_AddressType_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Person_AddressType_Record NewRecord()
		{
			return new GetAll_Person_AddressType_Record();
		}

		protected override GetAll_Person_AddressType_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Person_AddressType_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 155, 252, 12, 37, 106, 144, 225, 40, 126, 59, 184, 250, 92, 134, 212, 161 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "9BFC0C256A90E1287E3BB8FA5C86D4A1"; }
		}
	...
	public sealed partial class GetAll_Person_AddressType_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Person_AddressType_Record()
		{
		...
		public GetAll_Person_AddressType_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class GetAll_Person_AddressType_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
