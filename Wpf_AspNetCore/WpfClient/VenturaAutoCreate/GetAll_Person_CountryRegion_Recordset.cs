...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Person_CountryRegion_Recordset : ResultsetObservable<GetAll_Person_CountryRegion_Recordset, GetAll_Person_CountryRegion_Record>, IRecordsetBase
	{
		...
		public GetAll_Person_CountryRegion_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [CountryRegionCode],[Name],[ModifiedDate]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Person_CountryRegion_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Person_CountryRegion_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Person_CountryRegion_Record NewRecord()
		{
			return new GetAll_Person_CountryRegion_Record();
		}

		protected override GetAll_Person_CountryRegion_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Person_CountryRegion_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 57, 177, 159, 172, 171, 33, 155, 251, 61, 217, 166, 180, 77, 169, 172, 76 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "39B19FACAB219BFB3DD9A6B44DA9AC4C"; }
		}
	...
	public sealed partial class GetAll_Person_CountryRegion_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Person_CountryRegion_Record()
		{
		...
		public GetAll_Person_CountryRegion_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class GetAll_Person_CountryRegion_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
