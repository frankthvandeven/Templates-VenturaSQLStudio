...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Person_StateProvince_Recordset : ResultsetObservable<GetAll_Person_StateProvince_Recordset, GetAll_Person_StateProvince_Record>, IRecordsetBase
	{
		...
		public GetAll_Person_StateProvince_Recordset()
		{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Person_StateProvince_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Person_StateProvince_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Person_StateProvince_Record NewRecord()
		{
			return new GetAll_Person_StateProvince_Record();
		}

		protected override GetAll_Person_StateProvince_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Person_StateProvince_Record(columnvalues);
	...
	public sealed partial class GetAll_Person_StateProvince_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Person_StateProvince_Record()
		{
		...
		public GetAll_Person_StateProvince_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class GetAll_Person_StateProvince_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
