...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Production_Culture_Recordset : ResultsetObservable<GetAll_Production_Culture_Recordset, GetAll_Production_Culture_Record>, IRecordsetBase
	{
		...
		public GetAll_Production_Culture_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [CultureID],[Name],[ModifiedDate]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Production_Culture_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Production_Culture_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Production_Culture_Record NewRecord()
		{
			return new GetAll_Production_Culture_Record();
		}

		protected override GetAll_Production_Culture_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Production_Culture_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 58, 40, 102, 35, 141, 17, 183, 37, 52, 76, 62, 42, 161, 255, 52, 32 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "3A2866238D11B725344C3E2AA1FF3420"; }
		}
	...
	public sealed partial class GetAll_Production_Culture_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Production_Culture_Record()
		{
			_cur__CultureID = "";
			_cur__Name = "";
		...
		public GetAll_Production_Culture_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class GetAll_Production_Culture_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
