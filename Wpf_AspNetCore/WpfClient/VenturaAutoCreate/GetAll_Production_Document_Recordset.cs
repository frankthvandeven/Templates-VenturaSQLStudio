...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Production_Document_Recordset : ResultsetObservable<GetAll_Production_Document_Recordset, GetAll_Production_Document_Record>, IRecordsetBase
	{
		...
		public GetAll_Production_Document_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [DocumentNode],[DocumentLevel],[Title],[Owner],[FolderFlag],[FileName],[FileExtension],[Revision],[ChangeNumber],[Status],[DocumentSummary]," + CRLF +
			             @"[Document],[rowguid],[ModifiedDate]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Production_Document_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Production_Document_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Production_Document_Record NewRecord()
		{
			return new GetAll_Production_Document_Record();
		}

		protected override GetAll_Production_Document_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Production_Document_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 250, 160, 202, 86, 139, 249, 147, 68, 204, 10, 121, 202, 74, 255, 229, 69 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "FAA0CA568BF99344CC0A79CA4AFFE545"; }
		}
	...
	public sealed partial class GetAll_Production_Document_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Production_Document_Record()
		{
		...
		public GetAll_Production_Document_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class GetAll_Production_Document_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
