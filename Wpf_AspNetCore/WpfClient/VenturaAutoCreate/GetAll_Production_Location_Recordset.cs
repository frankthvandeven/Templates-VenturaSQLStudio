...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Production_Location_Recordset : ResultsetObservable<GetAll_Production_Location_Recordset, GetAll_Production_Location_Record>, IRecordsetBase
	{
		...
		public GetAll_Production_Location_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [LocationID],[Name],[CostRate],[Availability],[ModifiedDate]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Production_Location_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Production_Location_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Production_Location_Record NewRecord()
		{
			return new GetAll_Production_Location_Record();
		}

		protected override GetAll_Production_Location_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Production_Location_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 205, 30, 10, 25, 87, 10, 255, 173, 170, 198, 254, 243, 176, 183, 22, 173 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "CD1E0A19570AFFADAAC6FEF3B0B716AD"; }
		}
	...
	public sealed partial class GetAll_Production_Location_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Production_Location_Record()
		{
			_cur__LocationID = 0;
			_cur__Name = "";
			_cur__CostRate = 0.0m;
		...
		public GetAll_Production_Location_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class GetAll_Production_Location_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
