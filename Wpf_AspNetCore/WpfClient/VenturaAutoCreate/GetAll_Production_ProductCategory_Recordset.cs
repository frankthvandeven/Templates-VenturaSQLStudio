...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Production_ProductCategory_Recordset : ResultsetObservable<GetAll_Production_ProductCategory_Recordset, GetAll_Production_ProductCategory_Record>, IRecordsetBase
	{
		...
		public GetAll_Production_ProductCategory_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [ProductCategoryID],[Name],[rowguid],[ModifiedDate]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Production_ProductCategory_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Production_ProductCategory_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Production_ProductCategory_Record NewRecord()
		{
			return new GetAll_Production_ProductCategory_Record();
		}

		protected override GetAll_Production_ProductCategory_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Production_ProductCategory_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 10, 74, 189, 3, 34, 130, 211, 255, 141, 44, 87, 171, 184, 3, 229, 144 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "0A4ABD032282D3FF8D2C57ABB803E590"; }
		}
	...
	public sealed partial class GetAll_Production_ProductCategory_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Production_ProductCategory_Record()
		{
		...
		public GetAll_Production_ProductCategory_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class GetAll_Production_ProductCategory_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
