...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Production_ProductDescription_Recordset : ResultsetObservable<GetAll_Production_ProductDescription_Recordset, GetAll_Production_ProductDescription_Record>, IRecordsetBase
	{
		...
		public GetAll_Production_ProductDescription_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [ProductDescriptionID],[Description],[rowguid],[ModifiedDate]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Production_ProductDescription_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Production_ProductDescription_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Production_ProductDescription_Record NewRecord()
		{
			return new GetAll_Production_ProductDescription_Record();
		}

		protected override GetAll_Production_ProductDescription_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Production_ProductDescription_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 24, 130, 254, 188, 251, 11, 136, 48, 173, 89, 77, 140, 137, 216, 219, 183 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "1882FEBCFB0B8830AD594D8C89D8DBB7"; }
		}
	...
	public sealed partial class GetAll_Production_ProductDescription_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Production_ProductDescription_Record()
		{
		...
		public GetAll_Production_ProductDescription_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class GetAll_Production_ProductDescription_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
