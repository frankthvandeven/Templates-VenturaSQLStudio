...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Production_ProductPhoto_Recordset : ResultsetObservable<GetAll_Production_ProductPhoto_Recordset, GetAll_Production_ProductPhoto_Record>, IRecordsetBase
	{
		...
		public GetAll_Production_ProductPhoto_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [ProductPhotoID],[ThumbNailPhoto],[ThumbnailPhotoFileName],[LargePhoto],[LargePhotoFileName],[ModifiedDate]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Production_ProductPhoto_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Production_ProductPhoto_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Production_ProductPhoto_Record NewRecord()
		{
			return new GetAll_Production_ProductPhoto_Record();
		}

		protected override GetAll_Production_ProductPhoto_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Production_ProductPhoto_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 159, 251, 141, 91, 164, 99, 10, 234, 204, 19, 110, 57, 167, 107, 144, 164 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "9FFB8D5BA4630AEACC136E39A76B90A4"; }
		}
	...
	public sealed partial class GetAll_Production_ProductPhoto_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Production_ProductPhoto_Record()
		{
		...
		public GetAll_Production_ProductPhoto_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class GetAll_Production_ProductPhoto_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
