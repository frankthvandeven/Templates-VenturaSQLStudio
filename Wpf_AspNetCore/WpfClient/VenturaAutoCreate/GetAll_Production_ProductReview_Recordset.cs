...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Production_ProductReview_Recordset : ResultsetObservable<GetAll_Production_ProductReview_Recordset, GetAll_Production_ProductReview_Record>, IRecordsetBase
	{
		...
		public GetAll_Production_ProductReview_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [ProductReviewID],[ProductID],[ReviewerName],[ReviewDate],[EmailAddress],[Rating],[Comments],[ModifiedDate]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Production_ProductReview_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Production_ProductReview_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Production_ProductReview_Record NewRecord()
		{
			return new GetAll_Production_ProductReview_Record();
		}

		protected override GetAll_Production_ProductReview_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Production_ProductReview_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 218, 28, 248, 231, 25, 32, 254, 108, 238, 10, 247, 215, 17, 142, 181, 88 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "DA1CF8E71920FE6CEE0AF7D7118EB558"; }
		}
	...
	public sealed partial class GetAll_Production_ProductReview_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Production_ProductReview_Record()
		{
		...
		public GetAll_Production_ProductReview_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class GetAll_Production_ProductReview_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
