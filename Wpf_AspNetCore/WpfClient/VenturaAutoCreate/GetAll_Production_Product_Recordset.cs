...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Production_Product_Recordset : ResultsetObservable<GetAll_Production_Product_Recordset, GetAll_Production_Product_Record>, IRecordsetBase
	{
		...
		public GetAll_Production_Product_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [ProductID],[Name],[ProductNumber],[MakeFlag],[FinishedGoodsFlag],[Color],[SafetyStockLevel],[ReorderPoint],[StandardCost],[ListPrice]," + CRLF +
			             @"[Size],[SizeUnitMeasureCode],[WeightUnitMeasureCode],[Weight],[DaysToManufacture],[ProductLine],[Class],[Style],[ProductSubcategoryID],[ProductModelID]," + CRLF +
			             @"[SellStartDate],[SellEndDate],[DiscontinuedDate],[rowguid],[ModifiedDate]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Production_Product_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Production_Product_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Production_Product_Record NewRecord()
		{
			return new GetAll_Production_Product_Record();
		}

		protected override GetAll_Production_Product_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Production_Product_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 191, 118, 221, 140, 211, 99, 35, 219, 205, 235, 141, 233, 23, 31, 234, 225 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "BF76DD8CD36323DBCDEB8DE9171FEAE1"; }
		}
	...
	public sealed partial class GetAll_Production_Product_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Production_Product_Record()
		{
			_cur__ProductID = 0;
			_cur__Name = "";
			_cur__ProductNumber = "";
		...
		public GetAll_Production_Product_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class GetAll_Production_Product_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
