...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Production_ScrapReason_Recordset : ResultsetObservable<GetAll_Production_ScrapReason_Recordset, GetAll_Production_ScrapReason_Record>, IRecordsetBase
	{
		...
		public GetAll_Production_ScrapReason_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [ScrapReasonID],[Name],[ModifiedDate]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Production_ScrapReason_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Production_ScrapReason_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Production_ScrapReason_Record NewRecord()
		{
			return new GetAll_Production_ScrapReason_Record();
		}

		protected override GetAll_Production_ScrapReason_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Production_ScrapReason_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 236, 254, 64, 241, 48, 85, 222, 129, 47, 148, 138, 153, 134, 162, 51, 251 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "ECFE40F13055DE812F948A9986A233FB"; }
		}
	...
	public sealed partial class GetAll_Production_ScrapReason_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Production_ScrapReason_Record()
		{
		...
		public GetAll_Production_ScrapReason_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class GetAll_Production_ScrapReason_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
