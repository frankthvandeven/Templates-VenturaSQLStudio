...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Production_TransactionHistory_Recordset : ResultsetObservable<GetAll_Production_TransactionHistory_Recordset, GetAll_Production_TransactionHistory_Record>, IRecordsetBase
	{
		...
		public GetAll_Production_TransactionHistory_Recordset()
		{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Production_TransactionHistory_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Production_TransactionHistory_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Production_TransactionHistory_Record NewRecord()
		{
			return new GetAll_Production_TransactionHistory_Record();
		}

		protected override GetAll_Production_TransactionHistory_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Production_TransactionHistory_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 255, 147, 255, 74, 239, 195, 126, 11, 113, 208, 37, 71, 187, 228, 170, 153 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "FF93FF4AEFC37E0B71D02547BBE4AA99"; }
		}
	...
	public sealed partial class GetAll_Production_TransactionHistory_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Production_TransactionHistory_Record()
		{
		...
		public GetAll_Production_TransactionHistory_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class GetAll_Production_TransactionHistory_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
