...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Production_UnitMeasure_Recordset : ResultsetObservable<GetAll_Production_UnitMeasure_Recordset, GetAll_Production_UnitMeasure_Record>, IRecordsetBase
	{
		...
		public GetAll_Production_UnitMeasure_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [UnitMeasureCode],[Name],[ModifiedDate]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Production_UnitMeasure_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Production_UnitMeasure_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Production_UnitMeasure_Record NewRecord()
		{
			return new GetAll_Production_UnitMeasure_Record();
		}

		protected override GetAll_Production_UnitMeasure_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Production_UnitMeasure_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 228, 183, 145, 9, 234, 137, 27, 127, 176, 53, 247, 208, 133, 169, 41, 94 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "E4B79109EA891B7FB035F7D085A9295E"; }
		}
	...
	public sealed partial class GetAll_Production_UnitMeasure_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Production_UnitMeasure_Record()
		{
		...
		public GetAll_Production_UnitMeasure_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class GetAll_Production_UnitMeasure_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
