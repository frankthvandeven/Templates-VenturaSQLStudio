...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Purchasing_PurchaseOrderHeader_Recordset : ResultsetObservable<GetAll_Purchasing_PurchaseOrderHeader_Recordset, GetAll_Purchasing_PurchaseOrderHeader_Record>, IRecordsetBase
	{
		...
		public GetAll_Purchasing_PurchaseOrderHeader_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [PurchaseOrderID],[RevisionNumber],[Status],[EmployeeID],[VendorID],[ShipMethodID],[OrderDate],[ShipDate],[SubTotal],[TaxAmt],[Freight]," + CRLF +
			             @"[TotalDue],[ModifiedDate]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Purchasing_PurchaseOrderHeader_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Purchasing_PurchaseOrderHeader_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Purchasing_PurchaseOrderHeader_Record NewRecord()
		{
			return new GetAll_Purchasing_PurchaseOrderHeader_Record();
		}

		protected override GetAll_Purchasing_PurchaseOrderHeader_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Purchasing_PurchaseOrderHeader_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 208, 246, 45, 106, 182, 239, 183, 156, 199, 98, 135, 178, 222, 198, 215, 52 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "D0F62D6AB6EFB79CC76287B2DEC6D734"; }
		}
	...
	public sealed partial class GetAll_Purchasing_PurchaseOrderHeader_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Purchasing_PurchaseOrderHeader_Record()
		{
		...
		public GetAll_Purchasing_PurchaseOrderHeader_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class GetAll_Purchasing_PurchaseOrderHeader_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
