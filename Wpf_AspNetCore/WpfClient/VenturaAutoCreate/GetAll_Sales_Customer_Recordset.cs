...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Sales_Customer_Recordset : ResultsetObservable<GetAll_Sales_Customer_Recordset, GetAll_Sales_Customer_Record>, IRecordsetBase
	{
		...
		public GetAll_Sales_Customer_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [CustomerID],[PersonID],[StoreID],[TerritoryID],[AccountNumber],[rowguid],[ModifiedDate]" + CRLF +
			             @"FROM [Sales].[Customer]";
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Sales_Customer_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Sales_Customer_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Sales_Customer_Record NewRecord()
		{
			return new GetAll_Sales_Customer_Record();
		}

		protected override GetAll_Sales_Customer_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Sales_Customer_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 237, 253, 200, 227, 110, 138, 138, 133, 195, 21, 131, 37, 179, 193, 169, 214 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "EDFDC8E36E8A8A85C3158325B3C1A9D6"; }
		}
	...
	public sealed partial class GetAll_Sales_Customer_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Sales_Customer_Record()
		{
			_cur__CustomerID = 0;
			_cur__PersonID = null;
			_cur__StoreID = null;
		...
		public GetAll_Sales_Customer_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class GetAll_Sales_Customer_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
