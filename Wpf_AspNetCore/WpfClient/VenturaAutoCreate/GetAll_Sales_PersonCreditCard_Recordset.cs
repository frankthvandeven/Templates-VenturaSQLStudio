...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Sales_PersonCreditCard_Recordset : ResultsetObservable<GetAll_Sales_PersonCreditCard_Recordset, GetAll_Sales_PersonCreditCard_Record>, IRecordsetBase
	{
		...
		public GetAll_Sales_PersonCreditCard_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [BusinessEntityID],[CreditCardID],[ModifiedDate]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Sales_PersonCreditCard_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Sales_PersonCreditCard_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Sales_PersonCreditCard_Record NewRecord()
		{
			return new GetAll_Sales_PersonCreditCard_Record();
		}

		protected override GetAll_Sales_PersonCreditCard_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Sales_PersonCreditCard_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 111, 30, 199, 96, 134, 14, 188, 86, 186, 115, 111, 121, 81, 52, 149, 50 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "6F1EC760860EBC56BA736F7951349532"; }
		}
	...
	public sealed partial class GetAll_Sales_PersonCreditCard_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Sales_PersonCreditCard_Record()
		{
		...
		public GetAll_Sales_PersonCreditCard_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class GetAll_Sales_PersonCreditCard_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
