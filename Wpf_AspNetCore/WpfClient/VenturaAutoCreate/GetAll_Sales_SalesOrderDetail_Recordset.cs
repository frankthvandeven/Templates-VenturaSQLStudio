...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Sales_SalesOrderDetail_Recordset : ResultsetObservable<GetAll_Sales_SalesOrderDetail_Recordset, GetAll_Sales_SalesOrderDetail_Record>, IRecordsetBase
	{
		...
		public GetAll_Sales_SalesOrderDetail_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [SalesOrderID],[SalesOrderDetailID],[CarrierTrackingNumber],[OrderQty],[ProductID],[SpecialOfferID],[UnitPrice],[UnitPriceDiscount]," + CRLF +
			             @"[LineTotal],[rowguid],[ModifiedDate]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Sales_SalesOrderDetail_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Sales_SalesOrderDetail_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Sales_SalesOrderDetail_Record NewRecord()
		{
			return new GetAll_Sales_SalesOrderDetail_Record();
		}

		protected override GetAll_Sales_SalesOrderDetail_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Sales_SalesOrderDetail_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 167, 36, 68, 109, 14, 213, 248, 110, 161, 68, 198, 107, 151, 194, 115, 142 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "A724446D0ED5F86EA144C66B97C2738E"; }
		}
	...
	public sealed partial class GetAll_Sales_SalesOrderDetail_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Sales_SalesOrderDetail_Record()
		{
		...
		public GetAll_Sales_SalesOrderDetail_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class GetAll_Sales_SalesOrderDetail_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
