...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Sales_SalesOrderHeader_Recordset : ResultsetObservable<GetAll_Sales_SalesOrderHeader_Recordset, GetAll_Sales_SalesOrderHeader_Record>, IRecordsetBase
	{
		...
		public GetAll_Sales_SalesOrderHeader_Recordset()
		{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Sales_SalesOrderHeader_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Sales_SalesOrderHeader_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Sales_SalesOrderHeader_Record NewRecord()
		{
			return new GetAll_Sales_SalesOrderHeader_Record();
		}

		protected override GetAll_Sales_SalesOrderHeader_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Sales_SalesOrderHeader_Record(columnvalues);
	...
	public sealed partial class GetAll_Sales_SalesOrderHeader_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Sales_SalesOrderHeader_Record()
		{
		...
		public GetAll_Sales_SalesOrderHeader_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class GetAll_Sales_SalesOrderHeader_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
