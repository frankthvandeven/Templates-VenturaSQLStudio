...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Sales_SalesPerson_Recordset : ResultsetObservable<GetAll_Sales_SalesPerson_Recordset, GetAll_Sales_SalesPerson_Record>, IRecordsetBase
	{
		...
		public GetAll_Sales_SalesPerson_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [BusinessEntityID],[TerritoryID],[SalesQuota],[Bonus],[CommissionPct],[SalesYTD],[SalesLastYear],[rowguid],[ModifiedDate]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Sales_SalesPerson_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Sales_SalesPerson_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Sales_SalesPerson_Record NewRecord()
		{
			return new GetAll_Sales_SalesPerson_Record();
		}

		protected override GetAll_Sales_SalesPerson_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Sales_SalesPerson_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 34, 73, 224, 111, 218, 49, 150, 59, 104, 210, 194, 100, 73, 117, 48, 101 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "2249E06FDA31963B68D2C26449753065"; }
		}
	...
	public sealed partial class GetAll_Sales_SalesPerson_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Sales_SalesPerson_Record()
		{
		...
		public GetAll_Sales_SalesPerson_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class GetAll_Sales_SalesPerson_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
