...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Sales_SalesTerritoryHistory_Recordset : ResultsetObservable<GetAll_Sales_SalesTerritoryHistory_Recordset, GetAll_Sales_SalesTerritoryHistory_Record>, IRecordsetBase
	{
		...
		public GetAll_Sales_SalesTerritoryHistory_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT TOP(@RowLimit) [BusinessEntityID],[TerritoryID],[StartDate],[EndDate],[rowguid],[ModifiedDate]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Sales_SalesTerritoryHistory_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Sales_SalesTerritoryHistory_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Sales_SalesTerritoryHistory_Record NewRecord()
		{
			return new GetAll_Sales_SalesTerritoryHistory_Record();
		}

		protected override GetAll_Sales_SalesTerritoryHistory_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Sales_SalesTerritoryHistory_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 151, 30, 68, 149, 76, 126, 162, 236, 188, 105, 142, 19, 47, 8, 116, 211 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "971E44954C7EA2ECBC698E132F0874D3"; }
		}
	...
	public sealed partial class GetAll_Sales_SalesTerritoryHistory_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Sales_SalesTerritoryHistory_Record()
		{
		...
		public GetAll_Sales_SalesTerritoryHistory_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class GetAll_Sales_SalesTerritoryHistory_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
