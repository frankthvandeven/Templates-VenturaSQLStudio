...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_Sales_ShoppingCartItem_Recordset : ResultsetObservable<GetAll_Sales_ShoppingCartItem_Recordset, GetAll_Sales_ShoppingCartItem_Record>, IRecordsetBase
	{
		...
		public GetAll_Sales_ShoppingCartItem_Recordset()
		{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_Sales_ShoppingCartItem_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_Sales_ShoppingCartItem_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_Sales_ShoppingCartItem_Record NewRecord()
		{
			return new GetAll_Sales_ShoppingCartItem_Record();
		}

		protected override GetAll_Sales_ShoppingCartItem_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_Sales_ShoppingCartItem_Record(columnvalues);
	...
	public sealed partial class GetAll_Sales_ShoppingCartItem_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_Sales_ShoppingCartItem_Record()
		{
		...
		public GetAll_Sales_ShoppingCartItem_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class GetAll_Sales_ShoppingCartItem_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
