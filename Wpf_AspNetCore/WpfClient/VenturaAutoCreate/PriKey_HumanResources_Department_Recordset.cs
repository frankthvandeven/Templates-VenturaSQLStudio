...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class PriKey_HumanResources_Department_Recordset : ResultsetObservable<PriKey_HumanResources_Department_Recordset, PriKey_HumanResources_Department_Record>, IRecordsetBase
	{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_HumanResources_Department_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_HumanResources_Department_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_HumanResources_Department_Record NewRecord()
		{
			return new PriKey_HumanResources_Department_Record();
		}

		protected override PriKey_HumanResources_Department_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_HumanResources_Department_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 22, 133, 38, 228, 230, 154, 23, 222, 73, 218, 62, 224, 58, 156, 250, 183 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "168526E4E69A17DE49DA3EE03A9CFAB7"; }
		}
		...
		public void SetExecSqlParams(short? DepartmentID)
		{
			_inputparametervalues[0] = DepartmentID;
		}

		public void ExecSql(short? DepartmentID)
		{
			_inputparametervalues[0] = DepartmentID;
			Transactional.ExecSql(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
		}

		public void ExecSql(Connector connector, short? DepartmentID)
		{
			_inputparametervalues[0] = DepartmentID;
			Transactional.ExecSql(connector, new IRecordsetBase[] { this });
		}

		public async Task ExecSqlAsync(short? DepartmentID)
		{
			_inputparametervalues[0] = DepartmentID;
			await Transactional.ExecSqlAsync(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
		}

		public async Task ExecSqlAsync(Connector connector, short? DepartmentID)
		{
			_inputparametervalues[0] = DepartmentID;
	...
	public sealed partial class PriKey_HumanResources_Department_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_HumanResources_Department_Record()
		{
		...
		public PriKey_HumanResources_Department_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class PriKey_HumanResources_Department_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
