...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class PriKey_Person_BusinessEntity_Recordset : ResultsetObservable<PriKey_Person_BusinessEntity_Recordset, PriKey_Person_BusinessEntity_Record>, IRecordsetBase
	{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_Person_BusinessEntity_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_Person_BusinessEntity_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_Person_BusinessEntity_Record NewRecord()
		{
			return new PriKey_Person_BusinessEntity_Record();
		}

		protected override PriKey_Person_BusinessEntity_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_Person_BusinessEntity_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 179, 159, 179, 54, 212, 104, 19, 240, 34, 1, 128, 64, 109, 136, 175, 223 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "B39FB336D46813F0220180406D88AFDF"; }
		}
	...
	public sealed partial class PriKey_Person_BusinessEntity_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_Person_BusinessEntity_Record()
		{
		...
		public PriKey_Person_BusinessEntity_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class PriKey_Person_BusinessEntity_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
