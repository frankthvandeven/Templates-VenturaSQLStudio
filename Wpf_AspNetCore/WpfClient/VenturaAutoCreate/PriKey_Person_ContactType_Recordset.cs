...
{
	/// <summary>
	/// The updateable table is [Person].[ContactType]. Updateable table column information:
	/// • 3 out of 3 table columns are present in the resultset.
	/// • All primary key columns are present in the resultset: ContactTypeID.
	/// • Non-primary key columns present in the resultset: Name and ModifiedDate.
	/// Recordset item automatically created by VenturaSQL Studio.
	/// </summary>
	public partial class PriKey_Person_ContactType_Recordset : ResultsetObservable<PriKey_Person_ContactType_Recordset, PriKey_Person_ContactType_Record>, IRecordsetBase
	{
		...
		public PriKey_Person_ContactType_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT [ContactTypeID],[Name],[ModifiedDate]" + CRLF +
			             @"FROM [Person].[ContactType]" + CRLF +
			...
			((IResultsetBase)this).UpdateableTablename = "[Person].[ContactType]";
		}

		/// <summary>
		/// Database Column NotUpdateable. Table [Person].[ContactType]. PrimaryKey. NotReadonly. NotNull. IsIdentity. AutoIncrement.
		/// </summary>
		...
		/// <summary>
		/// Database Column Updateable. Table [Person].[ContactType]. NotReadonly. NotNull.
		/// </summary>
		public string Name
		{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_Person_ContactType_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_Person_ContactType_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_Person_ContactType_Record NewRecord()
		{
			return new PriKey_Person_ContactType_Record();
		}

		protected override PriKey_Person_ContactType_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_Person_ContactType_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 33, 81, 194, 123, 148, 191, 198, 141, 173, 2, 118, 27, 253, 123, 82, 49 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "2151C27B94BFC68DAD02761BFD7B5231"; }
		}
		...
		public void SetExecSqlParams(int? ContactTypeID)
		{
			_inputparametervalues[0] = ContactTypeID;
		}

		public void ExecSql(int? ContactTypeID)
		{
			_inputparametervalues[0] = ContactTypeID;
			Transactional.ExecSql(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
		}

		public void ExecSql(Connector connector, int? ContactTypeID)
		{
			_inputparametervalues[0] = ContactTypeID;
			Transactional.ExecSql(connector, new IRecordsetBase[] { this });
		}

		public async Task ExecSqlAsync(int? ContactTypeID)
		{
			_inputparametervalues[0] = ContactTypeID;
			await Transactional.ExecSqlAsync(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
		}

		public async Task ExecSqlAsync(Connector connector, int? ContactTypeID)
		{
			_inputparametervalues[0] = ContactTypeID;
	...
	public sealed partial class PriKey_Person_ContactType_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_Person_ContactType_Record()
		{
		...
		public PriKey_Person_ContactType_Record(object[] columnvalues)
		{
			_cur__ContactTypeID = (int)columnvalues[0];
		...
		void IRecordBase.WriteChangesToTrackArray(TrackArray track_array)
		{
			...
			{
				track_array.AppendPrikeyValue(0, (_mod__ContactTypeID && _started_with_dbvalues) ? _ori__ContactTypeID : _cur__ContactTypeID);
			}
		...
		{
			_cur__ContactTypeID = (int)value;
			OnPropertyChanged("ContactTypeID");
			OnAfterPropertyChanged("ContactTypeID");
		}
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class PriKey_Person_ContactType_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
