...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class PriKey_Production_BillOfMaterials_Recordset : ResultsetObservable<PriKey_Production_BillOfMaterials_Recordset, PriKey_Production_BillOfMaterials_Record>, IRecordsetBase
	{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_Production_BillOfMaterials_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_Production_BillOfMaterials_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_Production_BillOfMaterials_Record NewRecord()
		{
			return new PriKey_Production_BillOfMaterials_Record();
		}

		protected override PriKey_Production_BillOfMaterials_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_Production_BillOfMaterials_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 25, 126, 102, 17, 122, 207, 81, 152, 45, 41, 2, 38, 133, 216, 193, 182 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "197E66117ACF51982D29022685D8C1B6"; }
		}
		...
		public void SetExecSqlParams(int? ProductAssemblyID, int? ComponentID, DateTime? StartDate)
		{
			_inputparametervalues[0] = ProductAssemblyID;
			_inputparametervalues[1] = ComponentID;
			_inputparametervalues[2] = StartDate;
		}

		public void ExecSql(int? ProductAssemblyID, int? ComponentID, DateTime? StartDate)
		{
			_inputparametervalues[0] = ProductAssemblyID;
			_inputparametervalues[1] = ComponentID;
			_inputparametervalues[2] = StartDate;
		...
		public void ExecSql(Connector connector, int? ProductAssemblyID, int? ComponentID, DateTime? StartDate)
		{
			_inputparametervalues[0] = ProductAssemblyID;
			_inputparametervalues[1] = ComponentID;
			_inputparametervalues[2] = StartDate;
		...
		public async Task ExecSqlAsync(int? ProductAssemblyID, int? ComponentID, DateTime? StartDate)
		{
			_inputparametervalues[0] = ProductAssemblyID;
			_inputparametervalues[1] = ComponentID;
			_inputparametervalues[2] = StartDate;
		...
		public async Task ExecSqlAsync(Connector connector, int? ProductAssemblyID, int? ComponentID, DateTime? StartDate)
		{
			_inputparametervalues[0] = ProductAssemblyID;
			_inputparametervalues[1] = ComponentID;
			_inputparametervalues[2] = StartDate;
	...
	public sealed partial class PriKey_Production_BillOfMaterials_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_Production_BillOfMaterials_Record()
		{
		...
		public PriKey_Production_BillOfMaterials_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class PriKey_Production_BillOfMaterials_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
