...
{
	/// <summary>
	/// The updateable table is [Production].[ProductCategory]. Updateable table column information:
	/// • 4 out of 4 table columns are present in the resultset.
	/// • All primary key columns are present in the resultset: ProductCategoryID.
	/// • Non-primary key columns present in the resultset: Name, rowguid and ModifiedDate.
	/// Recordset item automatically created by VenturaSQL Studio.
	/// </summary>
	public partial class PriKey_Production_ProductCategory_Recordset : ResultsetObservable<PriKey_Production_ProductCategory_Recordset, PriKey_Production_ProductCategory_Record>, IRecordsetBase
	{
		...
		public PriKey_Production_ProductCategory_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT [ProductCategoryID],[Name],[rowguid],[ModifiedDate]" + CRLF +
			             @"FROM [Production].[ProductCategory]" + CRLF +
			...
			param_array.AddParameterColumn("@ProductCategoryID", typeof(int), true, false, DbType.Int32, null, null, null);
			...
			((IResultsetBase)this).UpdateableTablename = "[Production].[ProductCategory]";
		}

		/// <summary>
		/// Database Column NotUpdateable. Table [Production].[ProductCategory]. PrimaryKey. NotReadonly. NotNull. IsIdentity. AutoIncrement.
		/// </summary>
		...
		/// <summary>
		/// Database Column Updateable. Table [Production].[ProductCategory]. NotReadonly. NotNull.
		/// </summary>
		public string Name
		{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_Production_ProductCategory_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_Production_ProductCategory_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_Production_ProductCategory_Record NewRecord()
		{
			return new PriKey_Production_ProductCategory_Record();
		}

		protected override PriKey_Production_ProductCategory_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_Production_ProductCategory_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 31, 188, 65, 170, 9, 217, 170, 16, 253, 76, 210, 216, 85, 95, 158, 74 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "1FBC41AA09D9AA10FD4CD2D8555F9E4A"; }
		}
		...
		public void SetExecSqlParams(int? ProductCategoryID)
		{
			_inputparametervalues[0] = ProductCategoryID;
		}

		public void ExecSql(int? ProductCategoryID)
		{
			_inputparametervalues[0] = ProductCategoryID;
			Transactional.ExecSql(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
		}

		public void ExecSql(Connector connector, int? ProductCategoryID)
		{
			_inputparametervalues[0] = ProductCategoryID;
			Transactional.ExecSql(connector, new IRecordsetBase[] { this });
		}

		public async Task ExecSqlAsync(int? ProductCategoryID)
		{
			_inputparametervalues[0] = ProductCategoryID;
			await Transactional.ExecSqlAsync(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
		}

		public async Task ExecSqlAsync(Connector connector, int? ProductCategoryID)
		{
			_inputparametervalues[0] = ProductCategoryID;
	...
	public sealed partial class PriKey_Production_ProductCategory_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_Production_ProductCategory_Record()
		{
		...
		public PriKey_Production_ProductCategory_Record(object[] columnvalues)
		{
			_cur__ProductCategoryID = (int)columnvalues[0];
		...
		void IRecordBase.WriteChangesToTrackArray(TrackArray track_array)
		{
			...
			{
				track_array.AppendPrikeyValue(0, (_mod__ProductCategoryID && _started_with_dbvalues) ? _ori__ProductCategoryID : _cur__ProductCategoryID);
			}
		...
		{
			_cur__ProductCategoryID = (int)value;
			OnPropertyChanged("ProductCategoryID");
			OnAfterPropertyChanged("ProductCategoryID");
		}
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class PriKey_Production_ProductCategory_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
