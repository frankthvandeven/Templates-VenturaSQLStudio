...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class PriKey_Production_ProductCostHistory_Recordset : ResultsetObservable<PriKey_Production_ProductCostHistory_Recordset, PriKey_Production_ProductCostHistory_Record>, IRecordsetBase
	{
		...
		public PriKey_Production_ProductCostHistory_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT [ProductID],[StartDate],[EndDate],[StandardCost],[ModifiedDate]" + CRLF +
			             @"FROM [Production].[ProductCostHistory]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_Production_ProductCostHistory_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_Production_ProductCostHistory_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_Production_ProductCostHistory_Record NewRecord()
		{
			return new PriKey_Production_ProductCostHistory_Record();
		}

		protected override PriKey_Production_ProductCostHistory_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_Production_ProductCostHistory_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 167, 7, 83, 200, 243, 102, 206, 61, 95, 107, 218, 197, 27, 106, 20, 14 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "A70753C8F366CE3D5F6BDAC51B6A140E"; }
		}
	...
	public sealed partial class PriKey_Production_ProductCostHistory_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_Production_ProductCostHistory_Record()
		{
			_cur__ProductID = 0;
		...
		public PriKey_Production_ProductCostHistory_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class PriKey_Production_ProductCostHistory_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
