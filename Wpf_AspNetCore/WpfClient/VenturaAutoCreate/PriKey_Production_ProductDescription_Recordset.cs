...
{
	/// <summary>
	/// The updateable table is [Production].[ProductDescription]. Updateable table column information:
	/// • 4 out of 4 table columns are present in the resultset.
	/// • All primary key columns are present in the resultset: ProductDescriptionID.
	/// • Non-primary key columns present in the resultset: Description, rowguid and ModifiedDate.
	/// Recordset item automatically created by VenturaSQL Studio.
	/// </summary>
	public partial class PriKey_Production_ProductDescription_Recordset : ResultsetObservable<PriKey_Production_ProductDescription_Recordset, PriKey_Production_ProductDescription_Record>, IRecordsetBase
	{
		...
		public PriKey_Production_ProductDescription_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT [ProductDescriptionID],[Description],[rowguid],[ModifiedDate]" + CRLF +
			             @"FROM [Production].[ProductDescription]" + CRLF +
			...
			param_array.AddParameterColumn("@ProductDescriptionID", typeof(int), true, false, DbType.Int32, null, null, null);
			...
			schema_array.Add(new VenturaSqlColumn("ProductDescriptionID", typeof(int), false)
			{
				...
				BaseTableName = "ProductDescription",
			...
			((IResultsetBase)this).UpdateableTablename = "[Production].[ProductDescription]";
		}

		/// <summary>
		/// Database Column NotUpdateable. Table [Production].[ProductDescription]. PrimaryKey. NotReadonly. NotNull. IsIdentity. AutoIncrement.
		/// </summary>
		...
		/// <summary>
		/// Database Column Updateable. Table [Production].[ProductDescription]. NotReadonly. NotNull.
		/// </summary>
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_Production_ProductDescription_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_Production_ProductDescription_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_Production_ProductDescription_Record NewRecord()
		{
			return new PriKey_Production_ProductDescription_Record();
		}

		protected override PriKey_Production_ProductDescription_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_Production_ProductDescription_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 220, 97, 55, 103, 125, 41, 228, 100, 129, 110, 107, 18, 87, 238, 92, 80 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "DC6137677D29E464816E6B1257EE5C50"; }
		}
		...
		public void SetExecSqlParams(int? ProductDescriptionID)
		{
			_inputparametervalues[0] = ProductDescriptionID;
		}

		public void ExecSql(int? ProductDescriptionID)
		{
			_inputparametervalues[0] = ProductDescriptionID;
			Transactional.ExecSql(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
		}

		public void ExecSql(Connector connector, int? ProductDescriptionID)
		{
			_inputparametervalues[0] = ProductDescriptionID;
			Transactional.ExecSql(connector, new IRecordsetBase[] { this });
		}

		public async Task ExecSqlAsync(int? ProductDescriptionID)
		{
			_inputparametervalues[0] = ProductDescriptionID;
			await Transactional.ExecSqlAsync(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
		}

		public async Task ExecSqlAsync(Connector connector, int? ProductDescriptionID)
		{
			_inputparametervalues[0] = ProductDescriptionID;
	...
	public sealed partial class PriKey_Production_ProductDescription_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_Production_ProductDescription_Record()
		{
		...
		public PriKey_Production_ProductDescription_Record(object[] columnvalues)
		{
			_cur__ProductDescriptionID = (int)columnvalues[0];
		...
		void IRecordBase.WriteChangesToTrackArray(TrackArray track_array)
		{
			...
			{
				track_array.AppendPrikeyValue(0, (_mod__ProductDescriptionID && _started_with_dbvalues) ? _ori__ProductDescriptionID : _cur__ProductDescriptionID);
			}
		...
		{
			_cur__ProductDescriptionID = (int)value;
			OnPropertyChanged("ProductDescriptionID");
			OnAfterPropertyChanged("ProductDescriptionID");
		}
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class PriKey_Production_ProductDescription_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
