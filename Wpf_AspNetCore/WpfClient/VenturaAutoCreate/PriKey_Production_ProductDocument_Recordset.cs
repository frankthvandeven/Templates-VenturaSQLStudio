...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class PriKey_Production_ProductDocument_Recordset : ResultsetObservable<PriKey_Production_ProductDocument_Recordset, PriKey_Production_ProductDocument_Record>, IRecordsetBase
	{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_Production_ProductDocument_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_Production_ProductDocument_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_Production_ProductDocument_Record NewRecord()
		{
			return new PriKey_Production_ProductDocument_Record();
		}

		protected override PriKey_Production_ProductDocument_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_Production_ProductDocument_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 161, 239, 35, 45, 15, 33, 225, 46, 8, 111, 216, 72, 165, 212, 136, 126 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "A1EF232D0F21E12E086FD848A5D4887E"; }
		}
		...
		public void SetExecSqlParams(int? ProductID, object DocumentNode)
		{
			_inputparametervalues[0] = ProductID;
			_inputparametervalues[1] = DocumentNode;
		}

		public void ExecSql(int? ProductID, object DocumentNode)
		{
			_inputparametervalues[0] = ProductID;
			_inputparametervalues[1] = DocumentNode;
		...
		public void ExecSql(Connector connector, int? ProductID, object DocumentNode)
		{
			_inputparametervalues[0] = ProductID;
			_inputparametervalues[1] = DocumentNode;
		...
		public async Task ExecSqlAsync(int? ProductID, object DocumentNode)
		{
			_inputparametervalues[0] = ProductID;
			_inputparametervalues[1] = DocumentNode;
		...
		public async Task ExecSqlAsync(Connector connector, int? ProductID, object DocumentNode)
		{
			_inputparametervalues[0] = ProductID;
			_inputparametervalues[1] = DocumentNode;
	...
	public sealed partial class PriKey_Production_ProductDocument_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_Production_ProductDocument_Record()
		{
			_cur__ProductID = 0;
		...
		public PriKey_Production_ProductDocument_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class PriKey_Production_ProductDocument_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
