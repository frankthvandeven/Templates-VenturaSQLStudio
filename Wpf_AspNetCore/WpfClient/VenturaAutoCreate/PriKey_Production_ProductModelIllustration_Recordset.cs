...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class PriKey_Production_ProductModelIllustration_Recordset : ResultsetObservable<PriKey_Production_ProductModelIllustration_Recordset, PriKey_Production_ProductModelIllustration_Record>, IRecordsetBase
	{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_Production_ProductModelIllustration_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_Production_ProductModelIllustration_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_Production_ProductModelIllustration_Record NewRecord()
		{
			return new PriKey_Production_ProductModelIllustration_Record();
		}

		protected override PriKey_Production_ProductModelIllustration_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_Production_ProductModelIllustration_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 181, 23, 49, 94, 48, 9, 72, 245, 141, 196, 62, 136, 245, 136, 83, 129 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "B517315E300948F58DC43E88F5885381"; }
		}
		...
		public void SetExecSqlParams(int? ProductModelID, int? IllustrationID)
		{
			_inputparametervalues[0] = ProductModelID;
			_inputparametervalues[1] = IllustrationID;
		}

		public void ExecSql(int? ProductModelID, int? IllustrationID)
		{
			_inputparametervalues[0] = ProductModelID;
			_inputparametervalues[1] = IllustrationID;
		...
		public void ExecSql(Connector connector, int? ProductModelID, int? IllustrationID)
		{
			_inputparametervalues[0] = ProductModelID;
			_inputparametervalues[1] = IllustrationID;
		...
		public async Task ExecSqlAsync(int? ProductModelID, int? IllustrationID)
		{
			_inputparametervalues[0] = ProductModelID;
			_inputparametervalues[1] = IllustrationID;
		...
		public async Task ExecSqlAsync(Connector connector, int? ProductModelID, int? IllustrationID)
		{
			_inputparametervalues[0] = ProductModelID;
			_inputparametervalues[1] = IllustrationID;
	...
	public sealed partial class PriKey_Production_ProductModelIllustration_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_Production_ProductModelIllustration_Record()
		{
		...
		public PriKey_Production_ProductModelIllustration_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class PriKey_Production_ProductModelIllustration_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
