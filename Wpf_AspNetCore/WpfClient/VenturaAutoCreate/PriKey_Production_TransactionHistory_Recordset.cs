...
{
	/// <summary>
	/// The updateable table is [Production].[TransactionHistory]. Updateable table column information:
	...
	/// </summary>
	public partial class PriKey_Production_TransactionHistory_Recordset : ResultsetObservable<PriKey_Production_TransactionHistory_Recordset, PriKey_Production_TransactionHistory_Record>, IRecordsetBase
	{
		...
		public PriKey_Production_TransactionHistory_Recordset()
		{
			...
			_sqlscript = @"SELECT [TransactionID],[ProductID],[ReferenceOrderID],[ReferenceOrderLineID],[TransactionDate],[TransactionType],[Quantity],[ActualCost],[ModifiedDate]" + CRLF +
			             @"FROM [Production].[TransactionHistory]" + CRLF +
			...
			schema_array.Add(new VenturaSqlColumn("TransactionID", typeof(int), false)
			{
				...
				BaseTableName = "TransactionHistory",
			...
			((IResultsetBase)this).UpdateableTablename = "[Production].[TransactionHistory]";
		}

		/// <summary>
		/// Database Column NotUpdateable. Table [Production].[TransactionHistory]. PrimaryKey. NotReadonly. NotNull. IsIdentity. AutoIncrement.
		/// </summary>
		...
		/// <summary>
		/// Database Column Updateable. Table [Production].[TransactionHistory]. NotReadonly. NotNull.
		/// </summary>
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_Production_TransactionHistory_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_Production_TransactionHistory_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_Production_TransactionHistory_Record NewRecord()
		{
			return new PriKey_Production_TransactionHistory_Record();
		}

		protected override PriKey_Production_TransactionHistory_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_Production_TransactionHistory_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 13, 79, 90, 0, 205, 57, 71, 153, 96, 62, 183, 167, 83, 178, 245, 119 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "0D4F5A00CD394799603EB7A753B2F577"; }
		}
	...
	public sealed partial class PriKey_Production_TransactionHistory_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_Production_TransactionHistory_Record()
		{
		...
		public PriKey_Production_TransactionHistory_Record(object[] columnvalues)
		{
		...
		{
			_cur__TransactionID = (int)value;
			OnPropertyChanged("TransactionID");
			OnAfterPropertyChanged("TransactionID");
		}
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class PriKey_Production_TransactionHistory_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
