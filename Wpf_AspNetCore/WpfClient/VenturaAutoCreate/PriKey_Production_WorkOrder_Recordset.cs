...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class PriKey_Production_WorkOrder_Recordset : ResultsetObservable<PriKey_Production_WorkOrder_Recordset, PriKey_Production_WorkOrder_Record>, IRecordsetBase
	{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_Production_WorkOrder_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_Production_WorkOrder_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_Production_WorkOrder_Record NewRecord()
		{
			return new PriKey_Production_WorkOrder_Record();
		}

		protected override PriKey_Production_WorkOrder_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_Production_WorkOrder_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 94, 107, 189, 245, 202, 124, 0, 134, 207, 57, 147, 32, 210, 47, 84, 11 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "5E6BBDF5CA7C0086CF399320D22F540B"; }
		}
		...
		public void SetExecSqlParams(int? WorkOrderID)
		{
			_inputparametervalues[0] = WorkOrderID;
		}

		public void ExecSql(int? WorkOrderID)
		{
			_inputparametervalues[0] = WorkOrderID;
			Transactional.ExecSql(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
		}

		public void ExecSql(Connector connector, int? WorkOrderID)
		{
			_inputparametervalues[0] = WorkOrderID;
			Transactional.ExecSql(connector, new IRecordsetBase[] { this });
		}

		public async Task ExecSqlAsync(int? WorkOrderID)
		{
			_inputparametervalues[0] = WorkOrderID;
			await Transactional.ExecSqlAsync(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
		}

		public async Task ExecSqlAsync(Connector connector, int? WorkOrderID)
		{
			_inputparametervalues[0] = WorkOrderID;
	...
	public sealed partial class PriKey_Production_WorkOrder_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_Production_WorkOrder_Record()
		{
			_cur__WorkOrderID = 0;
			_cur__ProductID = 0;
			_cur__OrderQty = 0;
		...
		public PriKey_Production_WorkOrder_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class PriKey_Production_WorkOrder_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
