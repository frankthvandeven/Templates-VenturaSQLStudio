...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class PriKey_Purchasing_Vendor_Recordset : ResultsetObservable<PriKey_Purchasing_Vendor_Recordset, PriKey_Purchasing_Vendor_Record>, IRecordsetBase
	{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_Purchasing_Vendor_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_Purchasing_Vendor_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_Purchasing_Vendor_Record NewRecord()
		{
			return new PriKey_Purchasing_Vendor_Record();
		}

		protected override PriKey_Purchasing_Vendor_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_Purchasing_Vendor_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 58, 103, 106, 164, 33, 223, 212, 61, 125, 98, 117, 210, 82, 146, 73, 105 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "3A676AA421DFD43D7D6275D252924969"; }
		}
	...
	public sealed partial class PriKey_Purchasing_Vendor_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_Purchasing_Vendor_Record()
		{
		...
		public PriKey_Purchasing_Vendor_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class PriKey_Purchasing_Vendor_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
