...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class PriKey_Sales_CountryRegionCurrency_Recordset : ResultsetObservable<PriKey_Sales_CountryRegionCurrency_Recordset, PriKey_Sales_CountryRegionCurrency_Record>, IRecordsetBase
	{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_Sales_CountryRegionCurrency_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_Sales_CountryRegionCurrency_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_Sales_CountryRegionCurrency_Record NewRecord()
		{
			return new PriKey_Sales_CountryRegionCurrency_Record();
		}

		protected override PriKey_Sales_CountryRegionCurrency_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_Sales_CountryRegionCurrency_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 34, 235, 101, 8, 137, 69, 2, 105, 79, 24, 156, 87, 193, 20, 157, 193 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "22EB6508894502694F189C57C1149DC1"; }
		}
		...
		public void SetExecSqlParams(string CountryRegionCode, string CurrencyCode)
		{
			_inputparametervalues[0] = CountryRegionCode;
			_inputparametervalues[1] = CurrencyCode;
		}

		public void ExecSql(string CountryRegionCode, string CurrencyCode)
		{
			_inputparametervalues[0] = CountryRegionCode;
			_inputparametervalues[1] = CurrencyCode;
		...
		public void ExecSql(Connector connector, string CountryRegionCode, string CurrencyCode)
		{
			_inputparametervalues[0] = CountryRegionCode;
			_inputparametervalues[1] = CurrencyCode;
		...
		public async Task ExecSqlAsync(string CountryRegionCode, string CurrencyCode)
		{
			_inputparametervalues[0] = CountryRegionCode;
			_inputparametervalues[1] = CurrencyCode;
		...
		public async Task ExecSqlAsync(Connector connector, string CountryRegionCode, string CurrencyCode)
		{
			_inputparametervalues[0] = CountryRegionCode;
			_inputparametervalues[1] = CurrencyCode;
	...
	public sealed partial class PriKey_Sales_CountryRegionCurrency_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_Sales_CountryRegionCurrency_Record()
		{
		...
		public PriKey_Sales_CountryRegionCurrency_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class PriKey_Sales_CountryRegionCurrency_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
