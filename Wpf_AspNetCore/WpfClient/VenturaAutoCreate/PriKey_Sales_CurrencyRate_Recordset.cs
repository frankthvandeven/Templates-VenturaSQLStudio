...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class PriKey_Sales_CurrencyRate_Recordset : ResultsetObservable<PriKey_Sales_CurrencyRate_Recordset, PriKey_Sales_CurrencyRate_Record>, IRecordsetBase
	{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_Sales_CurrencyRate_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_Sales_CurrencyRate_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_Sales_CurrencyRate_Record NewRecord()
		{
			return new PriKey_Sales_CurrencyRate_Record();
		}

		protected override PriKey_Sales_CurrencyRate_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_Sales_CurrencyRate_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 182, 234, 161, 222, 80, 35, 113, 94, 129, 236, 17, 9, 105, 21, 169, 126 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "B6EAA1DE5023715E81EC11096915A97E"; }
		}
		...
		public void SetExecSqlParams(int? CurrencyRateID)
		{
			_inputparametervalues[0] = CurrencyRateID;
		}

		public void ExecSql(int? CurrencyRateID)
		{
			_inputparametervalues[0] = CurrencyRateID;
			Transactional.ExecSql(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
		}

		public void ExecSql(Connector connector, int? CurrencyRateID)
		{
			_inputparametervalues[0] = CurrencyRateID;
			Transactional.ExecSql(connector, new IRecordsetBase[] { this });
		}

		public async Task ExecSqlAsync(int? CurrencyRateID)
		{
			_inputparametervalues[0] = CurrencyRateID;
			await Transactional.ExecSqlAsync(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
		}

		public async Task ExecSqlAsync(Connector connector, int? CurrencyRateID)
		{
			_inputparametervalues[0] = CurrencyRateID;
	...
	public sealed partial class PriKey_Sales_CurrencyRate_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_Sales_CurrencyRate_Record()
		{
		...
		public PriKey_Sales_CurrencyRate_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class PriKey_Sales_CurrencyRate_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
