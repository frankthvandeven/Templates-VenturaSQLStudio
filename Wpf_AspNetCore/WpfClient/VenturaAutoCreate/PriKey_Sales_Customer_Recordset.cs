...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class PriKey_Sales_Customer_Recordset : ResultsetObservable<PriKey_Sales_Customer_Recordset, PriKey_Sales_Customer_Record>, IRecordsetBase
	{
		...
		public PriKey_Sales_Customer_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT [CustomerID],[PersonID],[StoreID],[TerritoryID],[AccountNumber],[rowguid],[ModifiedDate]" + CRLF +
			             @"FROM [Sales].[Customer]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_Sales_Customer_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_Sales_Customer_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_Sales_Customer_Record NewRecord()
		{
			return new PriKey_Sales_Customer_Record();
		}

		protected override PriKey_Sales_Customer_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_Sales_Customer_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 186, 4, 47, 7, 69, 217, 76, 52, 57, 94, 174, 232, 43, 50, 138, 41 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "BA042F0745D94C34395EAEE82B328A29"; }
		}
	...
	public sealed partial class PriKey_Sales_Customer_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_Sales_Customer_Record()
		{
			_cur__CustomerID = 0;
			_cur__PersonID = null;
			_cur__StoreID = null;
		...
		public PriKey_Sales_Customer_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class PriKey_Sales_Customer_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
