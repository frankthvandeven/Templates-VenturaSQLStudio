...
namespace WpfClient.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class PriKey_Sales_SalesTaxRate_Recordset : ResultsetObservable<PriKey_Sales_SalesTaxRate_Recordset, PriKey_Sales_SalesTaxRate_Record>, IRecordsetBase
	{
		...
		public PriKey_Sales_SalesTaxRate_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = @"SELECT [SalesTaxRateID],[StateProvinceID],[TaxType],[TaxRate],[Name],[rowguid],[ModifiedDate]" + CRLF +
			             @"FROM [Sales].[SalesTaxRate]" + CRLF +
			...
			param_array.AddParameterColumn("@SalesTaxRateID", typeof(int), true, false, DbType.Int32, null, null, null);
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_Sales_SalesTaxRate_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_Sales_SalesTaxRate_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_Sales_SalesTaxRate_Record NewRecord()
		{
			return new PriKey_Sales_SalesTaxRate_Record();
		}

		protected override PriKey_Sales_SalesTaxRate_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_Sales_SalesTaxRate_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 140, 95, 149, 96, 40, 40, 206, 21, 132, 160, 26, 174, 49, 234, 144, 152 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "8C5F95602828CE1584A01AAE31EA9098"; }
		}
		...
		public void SetExecSqlParams(int? SalesTaxRateID)
		{
			_inputparametervalues[0] = SalesTaxRateID;
		}

		public void ExecSql(int? SalesTaxRateID)
		{
			_inputparametervalues[0] = SalesTaxRateID;
			Transactional.ExecSql(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
		}

		public void ExecSql(Connector connector, int? SalesTaxRateID)
		{
			_inputparametervalues[0] = SalesTaxRateID;
			Transactional.ExecSql(connector, new IRecordsetBase[] { this });
		}

		public async Task ExecSqlAsync(int? SalesTaxRateID)
		{
			_inputparametervalues[0] = SalesTaxRateID;
			await Transactional.ExecSqlAsync(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
		}

		public async Task ExecSqlAsync(Connector connector, int? SalesTaxRateID)
		{
			_inputparametervalues[0] = SalesTaxRateID;
	...
	public sealed partial class PriKey_Sales_SalesTaxRate_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_Sales_SalesTaxRate_Record()
		{
		...
		public PriKey_Sales_SalesTaxRate_Record(object[] columnvalues)
		{
...
namespace WpfClient.VenturaAutoCreate
{
	public partial class PriKey_Sales_SalesTaxRate_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
